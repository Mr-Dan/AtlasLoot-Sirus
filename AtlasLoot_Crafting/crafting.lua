...
AtlasLoot_Data["Enchant_Tol'Garod"] = {
	...
	AtlasLoot_Data["JewelPrismatic1"] = {
		...
		{ 2, "s310821", "60113", "=q4= Сфера отрицания", "=ds="..AL["Vendor"]..", "..BabbleZone["Dalaran"] };
		{ 3, "s28028", "22459", "=q4=Void Sphere", "=ds="..GetSpellInfo(7411) };
		{ 4, "s56531", "42702", "=q3=Enchanted Tear", "=ds="..AL["Trainer"] };
		{ 5, "s28027", "22460", "=q3=Prismatic Sphere", "=ds="..GetSpellInfo(7411) };
		{ 6, "s56530", "42701", "=q2=Enchanted Pearl", "=ds="..AL["Trainer"] };
		{ 7, "s62941", "42701", "=q2=Prismatic Black Diamond", "=ds="..AL["Trainer"] };
		Back = "JEWELCRAFTINGMENU";
	};
	...
	AtlasLoot_Data["JewelDragonsEye1"] = {
		...
		{ 19, "s310872", "149184", "=q4= Стойкое Око дракона", "=ds="..AL["Vendor"]..", "..BabbleZone["Dalaran"] };
		{ 20, "s310873", "149185", "=q4= Непоколебимое Око дракона", "=ds="..AL["Vendor"]..", "..BabbleZone["Dalaran"] };	
