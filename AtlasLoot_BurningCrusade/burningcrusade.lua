...
--- World Bosses
	...
	AtlasLoot_Data["MountHyjalArchimonde"] = {
		...
		{ 20, 156174, "", "=q4=Рунический кубок Подпитки", "=ds=#s14#", "", "15%"};
		{ 21, 156175, "", "=q4=Кровавый пакт Маннорота", "=ds=#s14#", "", "15%"};
		{ 22, 156176, "", "=q4=Бесконечная кузня клинков", "=ds=#s14#", "", "15%"};
		{ 23, 156178, "", "=q4=Вечно-горячий уголь Скверны", "=ds=#s14#", "", "15%"};
