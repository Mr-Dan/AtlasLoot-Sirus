...
--- World Bosses
	...
	AtlasLoot_Data["MountHyjalArchimonde"] = {
		...
		{ 4, 156151, "", "=q4=Кольцо Красных слез", "=ds=#s13#", "", "14%"};
		...
		{ 20, 156168, "", "=q4=Кромка Катаклизма", "=ds=#h2#, #w10#", "", "15%"};
		{ 21, 156170, "", "=q4=Кромка Замерзшего Ада", "=ds=#h2#, #w10#", "", "15%"};
		{ 22, 156169, "", "=q4=Бьющееся сердце Хаоса", "=ds=#h1#, #w1#", "", "15%"};
		{ 24, 31095, "", "=q4=Шлем забытого завоевателя", "=ds=#m23# #e15#", ""};
		{ 25, 31096, "", "=q4=Шлем забытого защитника", "=ds=#m23# #e15#", ""};
		{ 26, 31097, "", "=q4=Шлем забытого покорителя", "=ds=#m23# #e15#", ""};
