...
--- World Bosses
	...
	AtlasLoot_Data["MountHyjalArchimonde"] = {
		{ 1, 156148, "", "=q4=Ботфорты темного ремесла", "=ds=#s12#, #a2#", "", "15%"};
		{ 2, 156149, "", "=q4=Окровавленный плащ повелителя проклятий", "=ds=#s4#", "", "14%"};
		--{ 3, 156150, "", "=q4=Ремень огневяза", "=ds=#s10#, #a2#", "", "16%"};
		{ 3, 156172, "", "=q4=Большой пояс Сокрушения", "=ds=#s10#, #a4#", "", "16%"};
		{ 4, 156173, "", "=q4=Защитный ремешок Трех Испытаний", "=ds=#s10#, #a4#", "", "16%"};
		{ 5, 156151, "", "=q4=Кольцо Красных слез", "=ds=#s13#", "", "14%"};
		{ 6, 156171, "", "=q4=Печатка превосходства Ман'ари", "=ds=#s13#", "", "14%"};
		--{ 5, 156152, "", "=q4=Скрепленные кожей цепи", "=ds=#s8#, #a3#", "", "15%"};
		--{ 6, 156153, "", "=q4=Нарукавье лавовой линии", "=ds=#s8#, #a3#", "", "15%"};
		{ 7, 156154, "", "=q4=Жезл полумесяца", "=ds=#w12#", "", "16%"};
		{ 8, 156155, "", "=q4=Прицельный перфоратор", "=ds=#w5#", "", "15%"};
		
		--{ 16, 156156, "", "=q4=Одеяния очищающего пламени", "=ds=#s5#, #a1#", "", "15%"};
		--{ 17, 156157, "", "=q4=Боевой доспех огненного великана", "=ds=#s5#, #a4#", "", "14%"};
		--{ 18, 156158, "", "=q4=Капюшон огненного ястреба", "=ds=#s1#, #a1#", "", "15%"};
		--{ 19, 156159, "", "=q4=Каска пламени,", "=ds=#s1#, #a4#", "", "15%"};
		{ 16, 156168, "", "=q4=Кромка Катаклизма", "=ds=#h2#, #w10#", "", "15%"};
		{ 17, 156170, "", "=q4=Кромка Замерзшего Ада", "=ds=#h2#, #w10#", "", "15%"};
		{ 18, 156169, "", "=q4=Бьющееся сердце Хаоса", "=ds=#h1#, #w1#", "", "15%"};
		{ 19, 156177, "", "=q4=Костяной клинок пытки Скверной", "=ds=#h1#, #w4#", "", "15%"};
		{ 20, 156174, "", "=q4=Рунический кубок Подпитки", "=ds=#s15#", "", "15%"};
		{ 21, 156175, "", "=q4=Кровавый пакт Маннорота", "=ds=#s15#", "", "15%"};
		{ 22, 156176, "", "=q4=Бесконечная кузня клинков", "=ds=#s15#", "", "15%"};
		{ 23, 156178, "", "=q4=Вечно-горячий уголь Скверны", "=ds=#s15#", "", "15%"};
		{ 25, 31095, "", "=q4=Шлем забытого завоевателя", "=ds=#m23# #e15#", ""};
		{ 26, 31096, "", "=q4=Шлем забытого защитника", "=ds=#m23# #e15#", ""};
		{ 27, 31097, "", "=q4=Шлем забытого покорителя", "=ds=#m23# #e15#", ""};
	...
	AtlasLoot_Data["MountHyjalTrash2"] = {
		{ 1, 97854, "", "=q4=Эскиз: Наследный камень императора", "=ds=#p12# (375)", "", "4%"};
		{ 2, 97855, "", "=q4=Эскиз: Ограненный камень хиджальских гор", "=ds=#p12# (375)", "", "4%"};
		{ 3, 97856, "", "=q4=Эскиз: Усиливающее слух кольцо преступника", "=ds=#p12# (375)", "", "4%"};
		{ 4, 97857, "", "=q4=Эскиз: Резонирующее кольцо гнева", "=ds=#p12# (375)", "", "4%"};
		{ 5, 97858, "", "=q4=Эскиз: Люминисцирующая яшма в оправе", "=ds=#p12# (375)", "", "4%"};
		{ 6, 97859, "", "=q4=Чертеж: Латные сапоги кузнеца света", "=ds=#p12# (375)", "", "4%"};
		{ 7, 97860, "", "=q4=Чертеж: Ботфорты кузни погибели", "=ds=#p12# (375)", "", "4%"};
		{ 8, 97861, "", "=q4=Чертеж: Утраченные сапоги ремесленника", "=ds=#p12# (375)", "", "4%"};
		{ 9, 97862, "", "=q4=Чертеж: Активная наручная защита ХМ-52 'Титан'", "=ds=#p12# (375)", "", "4%"};
		{ 10, 97863, "", "=q4=Чертеж: Наручные подавители боли ХМ-51 'Узурпатор'", "=ds=#p12# (375)", "", "4%"};
		{ 11, 97864, "", "=q4=Чертеж: Наручный источник сил ХМ-75 'Очищение'", "=ds=#p12# (375)", "", "4%"};
		{ 12, 97865, "", "=q4=Чертеж: Наручный сканер слабостей ХТ-27 'Трепет'", "=ds=#p12# (375)", "", "4%"};
		{ 13, 97866, "", "=q4=Чертеж: Наручная маскировка ХТ-92 'Леший'", "=ds=#p12# (375)", "", "4%"};
		{ 14, 97867, "", "=q4=Чертеж: Наручный целеуказатель ХЕ-41 'Раптор'", "=ds=#p12# (375)", "", "4%"};
		{ 15, 97868, "", "=q4=Чертеж: Наручный инъектор ХЕ-39 'Водяной'", "=ds=#p12# (375)", "", "4%"};
		{ 16, 97869, "", "=q4=Чертеж: Наручная электрозащита ХЕ-89 'Буря'", "=ds=#p12# (375)", "", "4%"};
		{ 17, 97870, "", "=q4=Выкройка: Поясное хранилище тяжелых игл", "=ds=#p12# (375)", "", "4%"};
		{ 18, 97871, "", "=q4=Выкройка: Опоясок с ножами для снятия шкур", "=ds=#p12# (375)", "", "4%"};
		{ 19, 97872, "", "=q4=Выкройка: Уплотненный пояс из электрохимеры", "=ds=#p12# (375)", "", "4%"};
		{ 20, 97873, "", "=q4=Выкройка: Гнилостный пояс из шкур вудралаков", "=ds=#p12# (375)", "", "4%"};
		{ 21, 97874, "", "=q4=Выкройка: Летний пояс мага-новичка", "=ds=#p12# (375)", "", "4%"};
		{ 22, 97875, "", "=q4=Выкройка: Старообрядческий пояс из шелка", "=ds=#p12# (375)", "", "4%"};
		{ 23, 97876, "", "=q4=Выкройка: Покров силы магии из ветроткани", "=ds=#p12# (375)", "", "4%"};
		{ 24, 97877, "", "=q4=Выкройка: Шаль силы духа из редкого шелка", "=ds=#p12# (375)", "", "4%"};
