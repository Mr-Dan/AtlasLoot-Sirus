...
AtlasLoot_Data["KaraAttumenHEROIC"] = {
	...
	AtlasLoot_Data["SunOffensive3_x4"] = {
		...
		{ 17, 34665, "", "=q3=Bombardier's Blade", "=ds=#h1#, #w4#", "50 #ssunmark#"};
		{ 18, 34667, "", "=q3=Archmage's Guile", "=ds=#h3#, #w10#", "50 #ssunmark#"};
		{ 19, 34672, "", "=q3=Inuuro's Blade", "=ds=#h1#, #w10#", "50 #ssunmark#"};
		{ 20, 34666, "", "=q3=The Sunbreaker", "=ds=#h1#, #w10#", "50 #ssunmark#"};
		{ 21, 34671, "", "=q3=K'iru's Presage", "=ds=#h3#, #w6#", "50 #ssunmark#"};
		{ 22, 34670, "", "=q3=Seeker's Gavel", "=ds=#h3#, #w6#", "50 #ssunmark#"};
		{ 23, 25799, "", "=q3=Мясорезчик", "=ds=#w3#", "50 #ssunmark#"};
		{ 24, 34674, "", "=q3=Truestrike Crossbow", "=ds=#w3#", "50 #ssunmark#"};
		{ 25, 34673, "", "=q3=Legionfoe", "=ds=#h2#, #w1#", "50 #ssunmark#"};
		{ 26, 22817, "", "=q3=Пронзатель сердец", "=ds=#w3#", "50 #ssunmark#"};
		{ 27, 29748, "", "=q3=Растущий посох", "=ds=#w3#", "50 #ssunmark#"};
		{ 28, 19879, "", "=q3=Крылатый ужас", "=ds=#w3#", "50 #ssunmark#"};
	...
	AtlasLoot_Data["SunOffensive5_x4"] = {
		...
		{ 17, 34678, "", "=q4=Shattered Sun Pendant of Acumen", "=ds=#s2#", "270 #ssunmark#"};
		{ 18, 34679, "", "=q4=Shattered Sun Pendant of Warrior Might", "=ds=#s2#", "270 #ssunmark#"};
		{ 19, 34680, "", "=q4=Shattered Sun Pendant of Resolve", "=ds=#s2#", "270 #ssunmark#"};
		{ 20, 34677, "", "=q4=Shattered Sun Pendant of Restoration", "=ds=#s2#", "270 #ssunmark#"};
		{ 21, 55262, "", "=q4=Shattered Sun Pendant of Ablutions", "=ds=#s2#", "270 #ssunmark#"};
		{ 22, 300098, "", "=q4=Shattered Sun Pendant of Might", "=ds=#s2#", "270 #ssunmark#"};
		{ 23, 34676, "", "=q4=Dawnforged Defender", "=ds=#w8#", "120 #ssunmark#"};
		{ 24, 34675, "", "=q4=Sunward Crest", "=ds=#w8#", "120 #ssunmark#"};
		{ 25, 50480, "", "=q3=лапмада танцующих углей", "=ds=#w8#", "120 #ssunmark#"};
