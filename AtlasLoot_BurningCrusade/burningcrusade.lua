...
--- World Bosses
	...
	AtlasLoot_Data["CFRSerpentHydrossHEROIC"] = {
		...
		--{ 16, 65072, "", "=q4=Heart of Rage", "=ds=#s14#", "", "18%"};
	...
	AtlasLoot_Data["CFRSerpentLeotherasHEROIC"] = {
		...
		{ 3, 59310, "", "=q4=Chaos Beast Bracers", "=ds=#s8#, #a3#", "", "19%"};
		{ 4, 65086, "", "=q4=Jumbotron Power Belt", "=ds=#s10#, #a4#", "", "17%"};
		{ 6, 65140, "", "=q4=Essence of the Cyclone", "=ds=#s14#", "", "18%"};
		{ 8, 65013, "", "=q4=Maldo's Sword Cane", "=ds=#h1#, #w10#", "", "20%"};
			{ 16, 280006, "", "=q1=", "=ds=#e15#"};
		--{ 16, 67429, "", "=q4=Gauntlets of the Forlorn Conqueror", "=ds=Tier 11 #e15#", "", "61%"};
		--{ 17, 67430, "", "=q4=Gauntlets of the Forlorn Protector", "=ds=Tier 11 #e15#", "", "62%"};
		--{ 18, 67431, "", "=q4=Gauntlets of the Forlorn Vanquisher", "=ds=Tier 11 #e15#", "", "61%"};
	...
	AtlasLoot_Data["CFRSerpentKarathressHEROIC"] = {
		{ 1, 65116, "", "=q4=Treads of Liquid Ice", "=ds=#s12#, #a1#", "", "15%"};
		{ 2, 65060, "", "=q4=Sark of the Unwatched", "=ds=#s5#, #a2#", "", "15%"};
		{ 3, 65059, "", "=q4=Ironstar Amulet", "=ds=#s2#", "", "15%"};
		{ 5, 65029, "", "=q4=Jar of Ancient Remedies", "=ds=#s14#", "", "15%"};
	--	{ 6, 65124, "", "=q4=Fall of Mortality", "=ds=#s14#", "", "14%"};
		{ 7, 65007, "", "=q4=Akirus the Worm-Breaker", "=ds=#h2#, #w6#", "", "15%"};
		{ 16, 280006, "", "=q1=", "=ds=#e15#"};
		--{ 16, 67426, "", "=q4=Leggings of the Forlorn Vanquisher", "=ds=Tier 11 #e15#", "", "62%"};
		--{ 17, 67427, "", "=q4=Leggings of the Forlorn Protector", "=ds=Tier 11 #e15#", "", "61%"};
		--{ 18, 67428, "", "=q4=Leggings of the Forlorn Conqueror", "=ds=Tier 11 #e15#", "", "62%"};
		{ 22, 30323, "", "=q4=Plans: Boots of the Protector", "=ds=#p2# (375)", "", "15%"};
	...
	AtlasLoot_Data["CFRSerpentMorogrimHEROIC"] = {
		...
		{ 18, 65094, "", "=q4=Fang of Twilight", "=ds=#h1#, #w10#", "", "20%"};
		{ 19, 65064, "", "=q4=Finkle's Mixer Upper", "=ds=#w12#", "", "15%"};
		{ 23, 30323, "", "=q4=Plans: Boots of the Protector", "=ds=#p2# (375)", "", "15%"};
	...
	AtlasLoot_Data["CFRSerpentVashjHEROIC"] = {
		...
		{ 12, 65058, "", "=q4=Themios the Darkbringer", "=ds=#w2#", "", "13%"};
		...
		{ 20, 81354, "", "=q4=Reins of the Azure Water Strider", "=ds=#e12#", "", "25%"};
		{ 24, 30323, "", "=q4=Plans: Boots of the Protector", "=ds=#p2# (375)", "", "15%"};
	...
	AtlasLoot_Data["GruulGruul"] = {
		...
		{ 22, 160000, "pvecurrency-valor", "=q3=Очки доблести", "=q5=x250     =q7="};
...
AtlasLoot_Data["KaraAttumenHEROIC"] = {
	...
	AtlasLoot_Data["TKEyeSolarianHEROIC"] = {
		...
		{ 16, 65022, "", "=q4=Пояс Чернорука", "=ds=#s10#, #a4#", ""};
	...
	AtlasLoot_Data["Netherwing1"] = {
		...
		{ 19, 32858, "", "=q4=Reins of the Azure Netherwing Drake", "=ds=#e12#"};
		{ 20, 32859, "", "=q4=Reins of the Cobalt Netherwing Drake", "=ds=#e12#"};
		{ 21, 32857, "", "=q4=Reins of the Onyx Netherwing Drake", "=ds=#e12#"};
		{ 22, 32860, "", "=q4=Reins of the Purple Netherwing Drake", "=ds=#e12#"};
		{ 23, 32861, "", "=q4=Reins of the Veridian Netherwing Drake", "=ds=#e12#"};
		{ 24, 32862, "", "=q4=Reins of the Violet Netherwing Drake", "=ds=#e12#"};
		Back = "REPMENU_BURNINGCRUSADE";
	};
	...
	AtlasLoot_Data["Skyguard1"] = {
		...
		{ 24, 38628, "", "=q3=Nether Ray Fry", "=ds=#e13#, 75 #jeton#"};
	...
	AtlasLoot_Data["T4DruidFeral"] = {
		...
		{ 17, 29761, "", "=q4=Шлем павшего заступника", "=ds=200 #jeton#"};
		{ 18, 29764, "", "=q4=Наплечье павшего заступника", "=ds=150 #jeton#"};
		{ 19, 29753, "", "=q4=Нагрудный доспех павшего заступника", "=ds=200 #jeton#"};
		{ 20, 29758, "", "=q4=Перчатки павшего заступника", "=ds=150 #jeton#"};
		{ 21, 29767, "", "=q4=Поножи павшего заступника", "=ds=200 #jeton#"};
	...
	AtlasLoot_Data["T4DeathKnightDPS"] = {
		...
		{ 16, 0, "INV_Box_01", "=q6=Токены", "=ds=Забытый (Даларан)"};
		{ 17, 29759, "", "=q4=Шлем павшего заступника", "=ds=200 #jeton#"};
		{ 18, 29762, "", "=q4=Наплечье павшего заступника", "=ds=150 #jeton#"};
		{ 19, 29755, "", "=q4=Нагрудный доспех павшего заступника", "=ds=200 #jeton#"};
		{ 20, 29756, "", "=q4=Перчатки павшего заступника", "=ds=150 #jeton#"};
		{ 21, 29765, "", "=q4=Поножи павшего заступника", "=ds=200 #jeton#"};
		{ 27, 0, "INV_Box_01", "=q6=Предметы", ""};
		{ 28, 280005, "", "=q4=Seal of Nether", "=ds=#e15#", "", ""};
		Back = "T4SET";
	};
	...
	{ 1, 0, "Spell_Holy_SealOfMight", "=q6=#t4s4_1#", "=ec1=#m21#"};
		...
		{ 16, 0, "INV_Box_01", "=q6=Токены", "=ds=Забытый (Даларан)"};
		{ 17, 29760, "", "=q4=Шлем павшего заступника", "=ds=200 #jeton#"};
		{ 18, 29763, "", "=q4=Наплечье павшего заступника", "=ds=150 #jeton#"};
		{ 19, 29754, "", "=q4=Нагрудный доспех павшего заступника", "=ds=200 #jeton#"};
		{ 20, 29757, "", "=q4=Перчатки павшего заступника", "=ds=150 #jeton#"};
		{ 21, 29766, "", "=q4=Поножи павшего заступника", "=ds=200 #jeton#"};
