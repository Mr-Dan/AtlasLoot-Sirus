...
---- Scourge Invasion
	...
	AtlasLoot_Data["RabbiSnegman"] = {
		...
		{ 19, 68394, "", "=q1=Ледоострая перчатка для фруктов", "=ds=#h3#, #w13# 25000#MarbledSnow#"};
		{ 20, 68395, "", "=q1=Обточенная льдом перчатка для подготовки ёлки", "=ds=#h4#, #w13# 25000#MarbledSnow#"};
		{ 21, 68396, "", "=q1=Обледеневший щит дворфа-бармена", "=ds=#h4#, #w8# 25000#MarbledSnow#"};
		{ 22, 68397, "", "=q1=Тяжелая крышка домовой трубы", "=ds=#h4#, #w8# 25000#MarbledSnow#"};
		{ 23, 68398, "", "=q1=Замерзшая сахарная тростинка", "=ds=#w12# 25000#MarbledSnow#"};
		{ 24, 68399, "", "=q1=Безобидный сетестрел маленьких помощников", "=ds=#w2# 40000#MarbledSnow#"};
		{ 25, 68400, "", "=q1=Захват для метания снежков", "=ds=#h4# 25000#MarbledSnow#"};
		Next ="RabbiSnegman1";
		Back = "WintervielMenu";
	}
	AtlasLoot_Data["RabbiSnegman1"] = {
		{ 1, 0, "INV_Holiday_Christmas_Present_01", "=q6="..AL["Animals"], ""};
		{ 2, 157108, "", "=q1=Колыбель дикого семени", "=ds=#e12# 10000#MarbledSnow#"};
		{ 3, 155801, "", "=q1=Поводья морозной гончей недр", "=ds=#e12# 10000#MarbledSnow#"};
		{ 4, 155792, "", "=q1=Праздничный корабль Зимнего Покрова", "=ds=#e12# 10000#MarbledSnow#"};
		{ 5, 157156, "", "=q1=Кор'же Леденящий", "=ds=#e13# 3000#MarbledSnow#"};
		{ 6, 157297, "", "=q1=Крошечный помощник Дедушки-Зимы", "=ds=#e13# 3000#MarbledSnow#"};
		Prev = "RabbiSnegman";
		Next = "RabbiSnegman2";
		Back = "WintervielMenu";
	}

	AtlasLoot_Data["RabbiSnegman2"] = {
		...
		{ 6, 99964, "", "=q1=Рекомендательный значок Скитальцев Тенебры", "=ds=#m20# 2500#MarbledSnow#"};
		{ 7, 99965, "", "=q1=Рекомендательный значок Дома Селентрис", "=ds=#m20# 2500#MarbledSnow#"};
		{ 8, 320154, "", "=q1=Рекомендательный значок Тенегорна", "=ds=#m20# 2500#MarbledSnow#"};
		{ 9, 320181, "", "=q1=Рекомендательный значок Саргераев", "=ds=#m20# 2500#MarbledSnow#"};
		{ 10, 320489, "", "=q1=Рекомендательный значок Атал'зула", "=ds=#m20# 2500#MarbledSnow#"};
		{ 11, 320388, "", "=q1=Рекомендательный значок Связанных Светом", "=ds=#m20# 2500#MarbledSnow#"};
		{ 12, 100370, "", "=q1=Карта полетов Восточных королевств", "=ds=#m20# 3000#MarbledSnow#"};
		{ 13, 100371, "", "=q1=Карта полетов Калимдор", "=ds=#m20# 3000#MarbledSnow#"};
		{ 14, 100372, "", "=q1=Карта полетов Запределья", "=ds=#m20# 3000#MarbledSnow#"};
		{ 15, 100373, "", "=q1=Карта полетов Нордскола", "=ds=#m20# 3000#MarbledSnow#"};
		{ 16, 156000, "", "=q1=Набор латной наследуемой экипировки защитника", "=ds=#m20# 10000#MarbledSnow#"};
		{ 17, 156001, "", "=q1=Набор латной наследуемой экипировки воителя", "=ds=#m20# 10000#MarbledSnow#"};
		{ 18, 156002, "", "=q1=Набор латной наследуемой экипировки целителя", "=ds=#m20# 10000#MarbledSnow#"};
		{ 19, 156003, "", "=q1=Набор кольчужной наследуемой экипировки заклинателя", "=ds=#m20# 10000#MarbledSnow#"};
		{ 20, 156004, "", "=q1=Набор кольчужной наследуемой экипировки воителя", "=ds=#m20# 10000#MarbledSnow#"};
		{ 21, 156005, "", "=q1=Набор кожаной наследуемой экипировки заклинателя", "=ds=#m20# 10000#MarbledSnow#"};
		{ 22, 156006, "", "=q1=Набор кожаной наследуемой экипировки воителя", "=ds=#m20# 10000#MarbledSnow#"};
		{ 23, 156007, "", "=q1=Набор тканевой наследуемой экипировки заклинателя", "=ds=#m20# 10000#MarbledSnow#"};
		{ 24, 53925, "", "=q1=Бойцовый снеговичок", "=ds=#e25# 20000#MarbledSnow#"};
		{ 25, 109964, "", "=q1=Ж.А.П.П.К.А. модели \"Легкий румянец\"", "=ds=#e25# 20000#MarbledSnow#"};
		{ 26, 53926, "", "=q1=Камень возвращения Зимнего Покрова", "=ds=#e25# 40000#MarbledSnow#"};
		{ 27, 157219, "", "=q1=Костюм красного новогоднего мурлока", "=ds=#e25# 40000#MarbledSnow#"};	
		Prev = "RabbiSnegman1";
		Back = "WintervielMenu";
	}
	...
	AtlasLoot_Data["FrozenSnowman'sLair"] = {
		...
		{ 23, 1000, "", "=q1=Свеча Зимнего Покрова", "=ds=#m20# "};
		{ 24, 38577, "", "=q1=П.Е.Т.А.Р.Д.А. для вечеринки", "=ds=#m20# "};
		{ 25, 97410, "", "=q1=Снежная капибара", "=ds=#e13# "};
		{ 26, 0, "INV_Holiday_Christmas_Present_01", "=q6="..AL["Trial"], ""};
		{ 27, 109965, "", "=q1=Ж.А.П.П.К.А. модели \"Хвойный лесок\"", "=ds=#e25#"};
		{ 28, 157220, "", "=q1=Костюм зеленого новогоднего мурлока", "=ds=#e25#"};
		{ 29, 157221, "", "=q1=Костюм желтого новогоднего мурлока", "=ds=#e25#"};
		{ 30, 157274, "", "=q1=Ледяной протозмей", "=ds=#e12#"};
		Back = "WintervielMenu";
	}
		--------------------
		--- Hallow's End ---
	...
	AtlasLoot_Data["Halloween1"] = {
		...
		{ 4, 18633, "", "=q1=Styleen's Sour Suckerpop", "=ds=#e3#"};
		{ 5, 18632, "", "=q1=Moonbrook Riot Taffy", "=ds=#e3#"};
		{ 6, 18635, "", "=q1=Bellara's Nutterbar", "=ds=#e3#"};
		{ 7, 20557, "", "=q1=Hallow's End Pumpkin Treat", "=ds=#m20#"};
		{ 8, 0, "inv_gauntlets_06", "=q6=#x40#", ""};
		{ 9, 37585, "", "=q3=Chewy Fel Taffy", "=ds=#m20#"};
		{ 10, 37583, "", "=q3=G.N.E.R.D.S.", "=ds=#m20#"};
		{ 11, 37582, "", "=q1=Pyroblast Cinnamon Ball", "=ds=#m20#"};
		{ 12, 37584, "", "=q1=Soothing Spearmint Candy", "=ds=#m20#"};
		{ 13, 155710, "", "=q6=Поводья Восставшего змея Тыквовина", "#e12#"};
		{ 14, 153116, "", "=q6=Дрожарик", "#e13#"};
		{ 15, 153186, "", "=q6=Вонючка", "#e13#"};
		{ 16, 0, "INV_Misc_Bag_11", "=q6=#x18#", ""};
		{ 17, 33292, "", "=q3=Hallowed Helm", "=ds=#s1#, #a1#"};
		{ 18, 33154, "", "=q3=Sinister Squashling", "=ds=#e13#"};
		{ 19, 153315, "", "=q6=Душитель", "#e13#"};
		{ 20, 20410, "", "=q1=Hallowed Wand - Bat", "=ds=#m20#"};
		{ 21, 20409, "", "=q1=Hallowed Wand - Ghost", "=ds=#m20#"};
		{ 22, 20399, "", "=q1=Hallowed Wand - Leper Gnome", "=ds=#m20#"};
		{ 23, 20398, "", "=q1=Hallowed Wand - Ninja", "=ds=#m20#"};
		{ 24, 20397, "", "=q1=Hallowed Wand - Pirate", "=ds=#m20#"};
		{ 25, 20413, "", "=q1=Hallowed Wand - Random", "=ds=#m20#"};
		{ 26, 20411, "", "=q1=Hallowed Wand - Skeleton", "=ds=#m20#"};
		{ 27, 20414, "", "=q1=Hallowed Wand - Wisp", "=ds=#m20#"};
		{ 28, 20389, "", "=q1=Candy Corn", "=ds=#e3#"};
		{ 29, 20388, "", "=q1=Lollipop", "=ds=#e3#"};
		{ 30, 20390, "", "=q1=Candy Bar", "=ds=#e3#"};	
		Next = "Halloween2";
		Back = "WORLDEVENTMENU";
	};
	...
	AtlasLoot_Data["LordAhune"] = {
		{ 1, 54805, "", "=q4=Плащ леденящих ветров", "=ds=#s4#"};
		{ 2, 379287, "", "=q4=Плащ леденящих ветров", "=ds=#s4#"};
		{ 3, 379288, "", "=q4=Плащ леденящих ветров", "=ds=#s4#"};
		{ 4, 379289, "", "=q4=Плащ леденящих ветров", "=ds=#s4#"};
		{ 5, 379290, "", "=q4=Плащ леденящих ветров", "=ds=#s4#"};
		{ 6, 379292, "", "=q4=Плащ леденящих ветров", "=ds=#s4#"};
		{ 7, 379293, "", "=q4=Плащ леденящих ветров", "=ds=#s4#"};
		{ 8, 379295, "", "=q4=Плащ леденящих ветров", "=ds=#s4#"};
		{ 9, 379296, "", "=q4=Плащ леденящих ветров", "=ds=#s4#"};
		{ 10, 379297, "", "=q4=Плащ леденящих ветров", "=ds=#s4#"};
		{ 16, 54801, "", "=q4=Icebound Cloak", "=ds=#s4#"};
		{ 17, 370243, "", "=q4=Icebound Cloak", "=ds=#s4#"};
		{ 18, 370244, "", "=q4=Icebound Cloak", "=ds=#s4#"};
		{ 19, 370245, "", "=q4=Icebound Cloak", "=ds=#s4#"};
		{ 20, 370246, "", "=q4=Icebound Cloak", "=ds=#s4#"};
		{ 21, 370248, "", "=q4=Icebound Cloak", "=ds=#s4#"};
		{ 22, 370249, "", "=q4=Icebound Cloak", "=ds=#s4#"};
		{ 23, 370251, "", "=q4=Icebound Cloak", "=ds=#s4#"};
		{ 24, 370252, "", "=q4=Icebound Cloak", "=ds=#s4#"};
		{ 25, 370253, "", "=q4=Icebound Cloak", "=ds=#s4#"};
		{ 13, 35723, "", "=q1=Shards of Ahune", "=ds=#m2#"};
		{ 14, 35279, "", "=q3=Tabard of Summer Skies", "=q1=#m4#: =ds=#s7#"};
		{ 15, 35280, "", "=q3=Tabard of Summer Flames", "=q1=#m4#: =ds=#s7#"};
		{ 28, 54536, "", "=q3=Satchel of Chilled Goods", "=ds="};
		{ 29, 35498, "", "=q3=Formula: Enchant Weapon - Deathfrost", "=ds=#p4# (350)"};
		{ 30, 53641, "", "=q3=Ice Chip", "=ds=#e13#"};
		Prev = "MidsummerFestival";
		Next = "LordAhune1";
		Back = "WORLDEVENTMENU";
	};
	
		AtlasLoot_Data["LordAhune1"] = {
		{ 1, 54804, "", "=q4=Shroud of Winter's Chill", "=ds=#s4#"};
		{ 2, 370276, "", "=q4=Shroud of Winter's Chill", "=ds=#s4#"};
		{ 3, 370277, "", "=q4=Shroud of Winter's Chill", "=ds=#s4#"};
		{ 4, 370278, "", "=q4=Shroud of Winter's Chill", "=ds=#s4#"};
		{ 5, 370279, "", "=q4=Shroud of Winter's Chill", "=ds=#s4#"};
		{ 6, 370281, "", "=q4=Shroud of Winter's Chill", "=ds=#s4#"};
		{ 7, 370282, "", "=q4=Shroud of Winter's Chill", "=ds=#s4#"};
		{ 8, 370284, "", "=q4=Shroud of Winter's Chill", "=ds=#s4#"};
		{ 9, 370285, "", "=q4=Shroud of Winter's Chill", "=ds=#s4#"};
		{ 10, 370286, "", "=q4=Shroud of Winter's Chill", "=ds=#s4#"};
		{ 16, 54803, "", "=q4=The Frost Lord's Battle Shroud", "=ds=#s4#"};
		{ 17, 370265, "", "=q4=The Frost Lord's Battle Shroud", "=ds=#s4#"};
		{ 18, 370266, "", "=q4=The Frost Lord's Battle Shroud", "=ds=#s4#"};
		{ 19, 370267, "", "=q4=The Frost Lord's Battle Shroud", "=ds=#s4#"};
		{ 20, 370268, "", "=q4=The Frost Lord's Battle Shroud", "=ds=#s4#"};
		{ 21, 370270, "", "=q4=The Frost Lord's Battle Shroud", "=ds=#s4#"};
		{ 22, 370271, "", "=q4=The Frost Lord's Battle Shroud", "=ds=#s4#"};
		{ 23, 370273, "", "=q4=The Frost Lord's Battle Shroud", "=ds=#s4#"};
		{ 24, 370274, "", "=q4=The Frost Lord's Battle Shroud", "=ds=#s4#"};
		{ 25, 370275, "", "=q4=The Frost Lord's Battle Shroud", "=ds=#s4#"};
		{ 13, 35723, "", "=q1=Shards of Ahune", "=ds=#m2#"};
		{ 14, 35279, "", "=q3=Tabard of Summer Skies", "=q1=#m4#: =ds=#s7#"};
		{ 15, 35280, "", "=q3=Tabard of Summer Flames", "=q1=#m4#: =ds=#s7#"};
		{ 28, 54536, "", "=q3=Satchel of Chilled Goods", "=ds="};
		...
		AtlasLoot_Data["LordAhune2"] = {
		{ 1, 54802, "", "=q4=The Frost Lord's War Cloak", "=ds=#s4#"};
		{ 2, 370254, "", "=q4=The Frost Lord's War Cloak", "=ds=#s4#"};
		{ 3, 370255, "", "=q4=The Frost Lord's War Cloak", "=ds=#s4#"};
		{ 4, 370256, "", "=q4=The Frost Lord's War Cloak", "=ds=#s4#"};
		{ 5, 370257, "", "=q4=The Frost Lord's War Cloak", "=ds=#s4#"};
		{ 6, 370259, "", "=q4=The Frost Lord's War Cloak", "=ds=#s4#"};
		{ 7, 370260, "", "=q4=The Frost Lord's War Cloak", "=ds=#s4#"};
		{ 8, 370262, "", "=q4=The Frost Lord's War Cloak", "=ds=#s4#"};
		{ 9, 370263, "", "=q4=The Frost Lord's War Cloak", "=ds=#s4#"};
		{ 10, 370264, "", "=q4=The Frost Lord's War Cloak", "=ds=#s4#"};
		{ 16, 54806, "", "=q4=Frostscythe of Lord Ahune", "=ds=#w9#"};
		{ 17, 370298, "", "=q4=Frostscythe of Lord Ahune", "=ds=#w9#"};
		{ 18, 370299, "", "=q4=Frostscythe of Lord Ahune", "=ds=#w9#"};
		{ 19, 370300, "", "=q4=Frostscythe of Lord Ahune", "=ds=#w9#"};
		{ 20, 370301, "", "=q4=Frostscythe of Lord Ahune", "=ds=#w9#"};
		{ 21, 370303, "", "=q4=Frostscythe of Lord Ahune", "=ds=#w9#"};
		{ 22, 370304, "", "=q4=Frostscythe of Lord Ahune", "=ds=#w9#"};
		{ 23, 370306, "", "=q4=Frostscythe of Lord Ahune", "=ds=#w9#"};
		{ 24, 370307, "", "=q4=Frostscythe of Lord Ahune", "=ds=#w9#"};
		{ 25, 370308, "", "=q4=Frostscythe of Lord Ahune", "=ds=#w9#"};
		{ 13, 35723, "", "=q1=Shards of Ahune", "=ds=#m2#"};
		{ 14, 35279, "", "=q3=Tabard of Summer Skies", "=q1=#m4#: =ds=#s7#"};
		{ 15, 35280, "", "=q3=Tabard of Summer Flames", "=q1=#m4#: =ds=#s7#"};
		{ 28, 54536, "", "=q3=Satchel of Chilled Goods", "=ds="};
	...
	AtlasLoot_Data["Darkmoon1"] = {
		...
		{ 3, 50475, "", "=q4=Фетиш новолуния", "=ds=#s2#", "1200 #darkmoon#", ""};	
		{ 4, 50476, "", "=q4=Подвеска новолуния", "=ds=#s2#", "1200 #darkmoon#", ""};
		{ 5, 50477, "", "=q4=Колье Новолуния", "=ds=#s2#", "1200 #darkmoon#", ""};
		{ 6, 34499, "", "=q2=Складной бумажный ветролет", "1000 #darkmoon#"};
		{ 7, 32465, "", "=q1=Счастливая Монета", "=ds=#h1#, #w6#", "1000 #darkmoon#", ""};
		{ 8, 34187, "", "=q1=Драконий череп", "500 #darkmoon#"};
		{ 9, 53880, "", "=q1=Супердевчачья рубашка", "=ds=#p5# (275)", "500 #darkmoon#", ""};
		{ 10, 26045, "", "=q1=Боевой знак Халаа", "=ds=", "100 #darkmoon#", ""};
		{ 11, 22729, "", "=q2=Схема: пульт управления паровым танком", "40 #darkmoon#"};
		{ 12, 45047, "", "=q1=Тигр-качалка", "=ds=#h1#, #w6#", "10 #darkmoon#", ""};
		{ 13, 19182, "", "=q1=Darkmoon Faire Prize Ticket", "=ds=#m17#"};---
