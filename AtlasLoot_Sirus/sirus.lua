...
AtlasLoot_Data["SIRUSLEGENDARYMENU"] = {
	...
	AtlasLoot_Data["PvPNewTokens_x4"] = {
		{ 1, 0, "INV_Box_01", "=q6=#arenaset6#", ""};
		{ 2, 100120, "", "=q6=Жетон для доспехов гневного гладиатора", "6400 #bgpoints# или 1600 #arenapoints# Служба:5.0 Арена:2.1"};
		{ 3, 100121, "", "=q6=Жетон для экипировки гневного гладиатора", "3200 #bgpoints# или 800 #arenapoints# Служба:3.0 Арена:2.0"};
		{ 4, 100122, "", "=q6=Жетон для двуручного оружия гневного гладиатора", "32000 #bgpoints# или 8000 #arenapoints# Служба:7.5 Арена:2.2"};
		{ 5, 100123, "", "=q6=Жетон для оружия правой руки гневного гладиатора", "24000 #bgpoints# или 6000 #arenapoints# Служба:7.5 Арена:2.2"};
		{ 6, 100124, "", "=q6=Жетон для оружия левой руки гневного гладиатора", "8000 #bgpoints# или 2000 #arenapoints# Служба:7.5 Арена:2.2"};
		{ 7, 100125, "", "=q6=Жетон для оружия дальнего боя гневного гладиатора", "8000 #bgpoints# или 2000 #arenapoints# Служба:7.5 Арена:2.2"};
		{ 8, 100161, "", "=q6=Жетон для жезла гневного гладиатора", "8000 #bgpoints# или 2000 #arenapoints# Служба:7.5 Арена:2.2"};
		{ 16, 0, "INV_Box_01", "=q6=#arenaset7#", ""};
		{ 17, 100126, "", "=q6=Жетон для доспехов неумолимого гладиатора", ""};
		{ 18, 100127, "", "=q6=Жетон для экипировки неумолимого гладиатора", ""};
		{ 19, 100128, "", "=q6=Жетон для двуручного оружия неумолимого гладиатора", ""};
	...
	AtlasLoot_Data["MillenniumRoulettex_x4"] = {
		...
		{ 23, 45087, "", "=q3=Руническая сфера", "=q5=x1     =q7="};	
...
{ 28, 0, "INV_Box_01", "=q6=Предмет", ""};
	...
	AtlasLoot_Data["Kor'kron_Battalion_x2"] = {
		...
		{ 16, 153745, "", "=q4=Договор об услугах наемника: Шаман", "=ds=85 #brewfest#"};
		{ 17, 153746, "", "=q4=Договор об услугах наемника: Разбойник", "=ds=85 #brewfest#"};
		{ 18, 153747, "", "=q4=Договор об услугах наемника: Воин", "=ds=85 #brewfest#"};
		{ 19, 153748, "", "=q4=Договор об услугах наемника: Друид", "=ds=85 #brewfest#"};
		{ 20, 153749, "", "=q4=Договор об услугах наемника: Жрец", "=ds=85 #brewfest#"};
		{ 21, 153750, "", "=q4=Договор об услугах наемника: Паладин", "=ds=85 #brewfest#"};
		{ 22, 153751, "", "=q4=Договор об услугах наемника: Маг", "=ds=85 #brewfest#"};
		{ 23, 154006, "", "=q4=Донесение разведки: Шаддрас", "=ds=2 #Tol'Garod#"};
		{ 24, 154007, "", "=q4=Донесение разведки: Костегрыз", "=ds=2 #Tol'Garod#"};
		{ 25, 154008, "", "=q4=Донесение разведки: Цунамий", "=ds=2 #Tol'Garod#"};
		{ 26, 154009, "", "=q4=Донесение разведки: Тайфун Оскверненный", "=ds=2 #Tol'Garod#"};
		{ 27, 154010, "", "=q4=Донесение разведки: Аргомот Буйный", "=ds=2 #Tol'Garod#"};
		{ 28, 154011, "", "=q4=Донесение разведки: Крок Кровопийца", "=ds=2 #Tol'Garod#"};
		{ 29, 154391, "", "=q4=Полноценный набор для модернизации", "=ds=50 #Tol'Garod#"};
		{ 30, 154392, "", "=q4=Превосходный набор для модернизации", "=ds=70 #Tol'Garod#"};
