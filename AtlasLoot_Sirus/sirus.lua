...
AtlasLoot_Data["SIRUSLEGENDARYMENU"] = {
	...
	AtlasLoot_Data["PvPNewTokens2_x2"] = {
		...
		{ 2, 100132, "", "=q6==Жетон для доспехов разгневанного гладиатора", "1600#bgpoints# 400#arenapoints##reqrating#6.0#reqrank#1.5"};
		{ 3, 100133, "", "=q6=Жетон для экипировки разгневанного гладиатора", "800#bgpoints# 200#arenapoints# #reqrating#5.6#reqrank#1.4"};
		{ 4, 100134, "", "=q6=Жетон для двуручного оружия разгневанного гладиатора", "8000#bgpoints# 2000#arenapoints##reqrating#6.5#reqrank#1.6"};
		{ 5, 100135, "", "=q6=Жетон для оружия правой руки разгневанного гладиатора", "6000#bgpoints# 1500#arenapoints##reqrating#6.5#reqrank#1.6"};
		{ 6, 100136, "", "=q6=Жетон для оружия левой руки разгневанного гладиатора", "2000#bgpoints# 500#arenapoints##reqrating#6.5#reqrank#1.6"};
		{ 7, 100137, "", "=q6=Жетон для оружия дальнего боя разгневанного гладиатора", "2000#bgpoints# 500#arenapoints##reqrating#6.5#reqrank#1.6"};
		{ 8, 100163, "", "=q6=Жетон для жезла  разгневанного", "2000#bgpoints# 500#arenapoints##reqrating#6.5#reqrank#1.6"};
		{ 16, 0, "INV_Box_01", "=q6=#arenaset9#", ""};
		{ 17, 103187, "", "=q6=Жетон для доспехов яростного гладиатора", "3200#bgpoints# 800#arenapoints# #reqrating#7.25#reqrank#1.8"};
		{ 18, 103188, "", "=q6=Жетон для экипировки яростного гладиатора", "1600#bgpoints# 400#arenapoints# #reqrating#6.8#reqrank#1.7"};
		{ 19, 103189, "", "=q6=Жетон для двуручного оружия яростного гладиатора", "16000#bgpoints# 4000#arenapoints# #reqrating#7.25#reqrank#1.9"};
		{ 20, 103190, "", "=q6=Жетон для оружия правой руки яростного гладиатора", "1200#bgpoints# 3000#arenapoints# #reqrating#7.25#reqrank#1.9"};
		{ 21, 103191, "", "=q6=Жетон для оружия левой руки яростного гладиатора", "4000#bgpoints# 1000#arenapoints# #reqrating#7.25#reqrank#1.9"};
		{ 22, 103192, "", "=q6=Жетон для оружия дальнего боя яростного гладиатора", "4000#bgpoints# 1000#arenapoints# #reqrating#7.25#reqrank#1.9"};
		{ 23, 103193, "", "=q6=Жетон для жезла яростного гладиатора", "4000#bgpoints# 1000#arenapoints# #reqrating#7.25#reqrank#1.9"};
	...
	AtlasLoot_Data["PvPNewTokens3_x2"] = {
		...
		{ 2, 103387, "", "=q6=Жетон для доспехов беспощадного гладиатора", "6400#bgpoints# 1600#arenapoints##reqrating#8.5#reqrank#2.1"};
		{ 3, 103388, "", "=q6=Жетон для экипировки беспощадного гладиатора", "3200#bgpoints# 800#arenapoints# #reqrating#8.0#reqrank#2.0"};
		{ 4, 103389, "", "=q6=Жетон для двуручного оружия беспощадного гладиатора", "32000#bgpoints# 8000#arenapoints##reqrating#9.0#reqrank#2.2"};
		{ 5, 103390, "", "=q6=Жетон для оружия правой руки беспощадного гладиатора", "24000#bgpoints# 6000#arenapoints##reqrating#9.0#reqrank#2.2"};
		{ 6, 103391, "", "=q6=Жетон для оружия левой руки беспощадного гладиатора", "8000#bgpoints# 2000#arenapoints##reqrating#9.0#reqrank#2.2"};
		{ 7, 103392, "", "=q6=Жетон для оружия дальнего боя беспощадного гладиатора", "8000#bgpoints# 2000#arenapoints##reqrating#9.0#reqrank#2.2"};
		{ 8, 103393, "", "=q6=Жетон для жезла беспощадного гладиатора", "8000#bgpoints# 2000#arenapoints##reqrating#9.0#reqrank#2.2"};
		Back = "PVPMENU";
		Prev = "PvPNewTokens2";
	};
