...
{ 28, 0, "INV_Box_01", "=q6=Предмет", ""};
	...
	AtlasLoot_Data["Zort"] ={
		...
		{ 3, 97758, "", "=q4=Плащ всепоглощающего безумия", "=ds=#s4#"};
		{ 4, 97759, "", "=q4=Пелена гниющего рассудка", "=ds=#s4#"};
		{ 5, 97767, "", "=q4=Знаки безликого воеводы", "=ds=#s8#, #a2#"};
		{ 6, 97766, "", "=q4=Неснимаемый пояс ритуалиста", "=ds=#s10#, #a2#"};
		{ 7, 97760, "", "=q4=Уродливые перчатки садиста", "=ds=#s9#, #a1#"};
		{ 8, 97761, "", "=q4=Окровавленные рукавицы мученика", "=ds=#s9#, #a3#"};
		{ 9, 97762, "", "=q4=Узурпирующая хватка", "=ds=#s9#, #a3#"};
		{ 10, 97763, "", "=q4=Перчатки тенехода", "=ds=#s9#, #a2#"};	
		{ 16, 97764, "", "=q4=Ирреальные ботфорты", "=ds=#s12#, #a2#"};
		{ 17, 97765, "", "=q4=Поступь возвышения", "=ds=#s12#, #a3#"};
		{ 18, 97753, "", "=q4=Перстень памяти крови", "=ds=#s13#"};
		{ 19, 97754, "", "=q4=Кольцо истекающего сердца", "=ds=#s13#"};
		{ 20, 97755, "", "=q4=Перстень сумеречного вождя", "=ds=#s13#"};
		{ 21, 97769, "", "=q4=Шепот Первого", "=ds=#s14#"};
		{ 22, 97768, "", "=q4=Разрушитель реальности", "=ds=#h1#, #w1#"};
