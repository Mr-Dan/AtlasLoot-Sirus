...
AtlasLoot_Data["SIRUSLEGENDARYMENU"] = {
	...
	AtlasLoot_Data["PvPNewTokens"] = {
		...
		{ 2, 100120, "", "=q6=Жетон для доспехов гневного гладиатора", "1600#bgpoints#/400#arenapoints# #reqrating#1.5#reqrank#1.5"};
		{ 3, 100121, "", "=q6=Жетон для экипировки гневного гладиатора", "800#bgpoints#/200#arenapoints# #reqrating#1.4#reqrank#1.4"};
		{ 4, 100122, "", "=q6=Жетон для двуручного оружия гневного гладиатора", "8000#bgpoints#/2000#arenapoints# #reqrating#1.6#reqrank# 1.6"};
		{ 5, 100123, "", "=q6=Жетон для оружия правой руки гневного гладиатора", "6000#bgpoints#/1500#arenapoints# #reqrating#1.6#reqrank# 1.6"};
		{ 6, 100124, "", "=q6=Жетон для оружия левой руки гневного гладиатора", "2000#bgpoints#/500#arenapoints# #reqrating#1.6#reqrank# 1.6"};
		{ 7, 100125, "", "=q6=Жетон для оружия дальнего боя гневного гладиатора", "2000#bgpoints#/500#arenapoints# #reqrating#1.6#reqrank# 1.6"};
		{ 8, 100161, "", "=q6=Жетон для жезла гневного гладиатора", "2000#bgpoints#/500 #arenapoints# #reqrating#1.6 #reqrank# 1.6"};
		{ 16, 0, "INV_Box_01", "=q6=#arenaset7#", ""};
		{ 17, 100126, "", "=q6=Жетон для доспехов неумолимого гладиатора", "x1 3200#bgpoints#/800#arenapoints# #reqrating#1.8#reqrank#1.8"};
		{ 18, 100127, "", "=q6=Жетон для экипировки неумолимого гладиатора", "x1 1600#bgpoints#/400#arenapoints# #reqrating#1.7#reqrank#1.7"};
		{ 19, 100128, "", "=q6=Жетон для двуручного оружия неумолимого гладиатора", "x1 16000#bgpoints#/4000#arenapoints# #reqrating#1.9#reqrank#1.9"};
		{ 20, 100129, "", "=q6=Жетон для оружия правой руки неумолимого гладиатора", "x1 1200#bgpoints#/3000#arenapoints# #reqrating#1.9#reqrank#1.9"};
		{ 21, 100130, "", "=q6=Жетон для оружия левой руки неумолимого гладиатора", "x1 4000#bgpoints#/1000#arenapoints# #reqrating#1.9#reqrank#1.9"};
		{ 22, 100131, "", "=q6=Жетон для оружия дальнего боя неумолимого гладиатора", "x1 4000#bgpoints#/1000#arenapoints# #reqrating#1.9#reqrank#1.9"};
		{ 23, 100162, "", "=q6=Жетон для жезла неумолимого гладиатора", "x1 4000#bgpoints#/1000#arenapoints##reqrating#1.9#reqrank# 1.9"};
	...
	AtlasLoot_Data["PvPNewTokens2"] = {
		{ 1, 0, "INV_Box_01", "=q6=#arenaset8x1#", ""};
		{ 2, 100132, "", "=q6==Жетон для доспехов я гладиатора", "6400#bgpoints#/1600#arenapoints##reqrating#2.1#reqrank#2.1"};
		{ 3, 100133, "", "=q6=Жетон для экипировки беспощадного гладиатора", "3200#bgpoints#/800#arenapoints# #reqrating#2.0#reqrank#2.0"};
		{ 4, 100134, "", "=q6=Жетон для двуручного оружия беспощадного гладиатора", "32000#bgpoints#/8000#arenapoints##reqrating#2.2#reqrank#2.2"};
		{ 5, 100135, "", "=q6=Жетон для оружия правой руки беспощадного гладиатора", "24000#bgpoints#/6000#arenapoints##reqrating#2.2#reqrank#2.2"};
		{ 6, 100136, "", "=q6=Жетон для оружия левой руки беспощадного гладиатора", "8000#bgpoints#/2000#arenapoints##reqrating#2.2#reqrank#2.2"};
		{ 7, 100137, "", "=q6=Жетон для оружия дальнего боя беспощадного гладиатора", "8000#bgpoints#/2000#arenapoints##reqrating#2.2#reqrank#2.2"};
		{ 8, 100163, "", "=q6=Жетон для жезла беспощадного беспощадного", "8000#bgpoints#/2000#arenapoints##reqrating#2.2#reqrank#2.2"};
		{ 16, 0, "INV_Box_01", "=q6=#arenaset8x2#", ""};
		{ 17, 100132, "", "=q6=Жетон для экипировки беспощадного гладиатора", "1600#bgpoints#/400#arenapoints# #reqrating#1.5#reqrank#1.5"};
		{ 18, 100133, "", "=q6=Жетон для экипировки беспощадного гладиатора", "800#bgpoints#/200#arenapoints# #reqrating#1.4#reqrank#1.4"};
		{ 19, 100134, "", "=q6=Жетон для двуручного оружия беспощадного гладиатора", "8000#bgpoints#/2000#arenapoints# #reqrating#1.6#reqrank# 1.6"};
		{ 20, 100135, "", "=q6=Жетон для оружия правой руки беспощадного гладиатора", "6000#bgpoints#/1500#arenapoints# #reqrating#1.6#reqrank# 1.6"};
		{ 21, 100136, "", "=q6=Жетон для оружия левой руки беспощадного гладиатора", "2000#bgpoints#/500#arenapoints# #reqrating#1.6#reqrank# 1.6"};
		{ 22, 100137, "", "=q6=Жетон для оружия дальнего боя беспощадного гладиатора", "2000#bgpoints#/500#arenapoints# #reqrating#1.6#reqrank# 1.6"};
		{ 23, 100163, "", "=q6=Жетон для жезла беспощадного гладиатора", "2000#bgpoints#/500#arenapoints# #reqrating#1.6#reqrank# 1.6"};
	...
	AtlasLoot_Data["PvPNewTokens3"] = {
		...
		{ 2, 103187, "", "=q6=Жетон для доспехов яростного гладиатора", "3200#bgpoints#/800#arenapoints# #reqrating#1.8#reqrank#1.8"};
		{ 3, 103188, "", "=q6=Жетон для экипировки яростного гладиатора", "1600#bgpoints#/400#arenapoints# #reqrating#1.7#reqrank#1.7"};
		{ 4, 103189, "", "=q6=Жетон для двуручного оружия яростного гладиатора", "16000#bgpoints#/4000#arenapoints# #reqrating#1.9#reqrank#1.9"};
		{ 5, 103190, "", "=q6=Жетон для оружия правой руки яростного гладиатора", "1200#bgpoints#/3000#arenapoints# #reqrating#1.9#reqrank#1.9"};
		{ 6, 103191, "", "=q6=Жетон для оружия левой руки яростного гладиатора", "4000#bgpoints#/1000#arenapoints# #reqrating#1.9#reqrank#1.9"};
		{ 7, 103192, "", "=q6=Жетон для оружия дальнего боя яростного гладиатора", "4000#bgpoints#/1000#arenapoints# #reqrating#1.9#reqrank#1.9"};
		{ 8, 103193, "", "=q6=Жетон для жезла яростного гладиатора", "4000#bgpoints#/1000#arenapoints# #reqrating#1.9#reqrank#1.9"};
		{ 16, 0, "INV_Box_01", "=q6=#arenaset10#", ""};
		{ 17, 103387, "", "=q6=Жетон для доспехов яростного гладиатора", "6400#bgpoints#/1600#arenapoints##reqrating#2.1#reqrank#2.1"};
		{ 18, 103388, "", "=q6=Жетон для экипировки яростного гладиатора", "3200#bgpoints#/800#arenapoints# #reqrating#2.0#reqrank#2.0"};
		{ 19, 103389, "", "=q6=Жетон для двуручного оружия яростного гладиатора", "32000#bgpoints#/8000#arenapoints##reqrating#2.2#reqrank#2.2"};
		{ 20, 103390, "", "=q6=Жетон для оружия правой руки яростного гладиатора", "24000#bgpoints#/6000#arenapoints##reqrating#2.2#reqrank#2.2"};
		{ 21, 103391, "", "=q6=Жетон для оружия левой руки яростного гладиатора", "8000#bgpoints#/2000#arenapoints##reqrating#2.2#reqrank#2.2"};
		{ 22, 103392, "", "=q6=Жетон для оружия дальнего боя яростного гладиатора", "8000#bgpoints#/2000#arenapoints##reqrating#2.2#reqrank#2.2"};
		{ 23, 103393, "", "=q6=Жетон для жезла яростного гладиатора", "8000#bgpoints#/2000#arenapoints##reqrating#2.2#reqrank#2.2"};
		Back = "PVPMENU";
		Prev = "PvPNewTokens2";
	};
	...
	AtlasLoot_Data["RageSaddle"] = {
		...
		{ 9, 52177, "", "=q4=Carnelian", "=ds=#e7#","9000#bgpoints#2250#arenapoints##reqrating#1.9/#reqrank#1.9"};
		{ 10, 52179, "", "=q4=Alicite", "=ds=#e7#", "9000#bgpoints#2250#arenapoints##reqrating#1.9/#reqrank#1.9"};
		{ 11, 52181, "", "=q4=Hessonite", "=ds=#e7#", "6000#bgpoints#1500#arenapoints##reqrating#1750/#reqrank#1750"};
		{ 12, 52178, "", "=q4=Zephyrite", "=ds=#e7#", "6000#bgpoints#1500#arenapoints##reqrating#1750/#reqrank#1750"};
		{ 13, 52182, "", "=q4=Jasper", "=ds=#e7#", "2000#bgpoints#500#arenapoints##reqrating#1.6/#reqrank#1.6"};
		{ 14, 52180, "", "=q4=Nightstone", "=ds=#e7#", "2000#bgpoints#500#arenapoints##reqrating#1.6/#reqrank#1.6"};
		{ 15, 95620, "", "=q4=Кошель ювелира", "=ds=", "4000#bgpoints#1000#arenapoints##reqrating#1.6/#reqrank#1.6"};

		
		{ 16, 0, "INV_Box_01", "=q6=Орда", ""};
		{ 17, 155333, "", "=q4=Поводья Бирюзового боевого коня-скелета фаворита", "=ds=#w15#", "20000 #bgpoints# 5000 #arenapoints# #reqrank# 1.9"};
		{ 18, 155377, "", "=q4=Поводья Обагренного яростного боевого кодо", "=ds=#w15#", "20000 #bgpoints# 5000 #arenapoints# #reqrank# 1.9"};
		{ 19, 155007, "", "=q4=Поводья Темнокрылого дракондора", "=ds=#w15#", "30000 #bgpoints# 7500 #arenapoints# #reqrank# 2.0"};
		
		{ 21, 0, "INV_Box_01", "=q6=Альянс", ""};		
		{ 22, 155375, "", "=q4=Поводья Багрового механодолгонога", "=ds=#w15#", "20000 #bgpoints# 5000 #arenapoints# #reqrank# 1.9"};
		{ 23, 155380, "", "=q4=Поводья Нефритового яростного боевого элекка", "=ds=#w15#", "20000 #bgpoints# 5000 #arenapoints# #reqrank# 1.9"};		
		{ 24, 155008, "", "=q4=Поводья Пепельношкурого дракондора", "=ds=#w15#", "30000 #bgpoints# 7500 #arenapoints# #reqrank# 2.0"};
		Back = "PVPMENU";
	};
	...
	local alharenaicon
		...
		AtlasLoot_Data["MillenniumRoulettex2"] = {
		...
		Next ="MillenniumRoulettex1";
		Back = "KATEGORIAMENU";
	};
	
	AtlasLoot_Data["MillenniumRoulettex1"] = {
		{ 1, 0, "inv_misc_coin_19", "=q6=Обычный", ""};
		{ 2, 0, alhhonoricon, "=q3=Очки чести", "=q5=x100     =q7="};
		{ 3, 0, alharenaicon, "=q3=Очки арены", "=q5=x25     =q7="};
		{ 4, 160000, "pvecurrency-valor", "=q3=Очки доблести", "=q5=x50     =q7="};
		{ 5, 280512, "", "=q3=Жетон запределья ", "=q5=x7     =q7="};
		{ 6, 100585, "", "=q3=Превосходный кристалл расширения памяти", "=q5=х5     =q7="};
		{ 7, 99998, "", "=q3=Руна Лили", "=q5=x1     =q7="};
		{ 8, 23572, "", "=q3=Изначальная пустота", "=q5=x1     =q7="};
		...
		{ 18, 0, alharenaicon, "=q3=Очки арены", "=q5=x125     =q7="};
		{ 19, 160000, "pvecurrency-valor", "=q3=Очки доблести", "=q5=x250     =q7="};
		{ 20, 49908, "", "=q3=Древнейший саронит", "=q5=x1     =q7="};
		{ 21, 100000, "", "=q3=Руна Сируса", "=q5=x1     =q7="};
		{ 22, 280505, "", "=q3=Черный бриллиант", "=q5=x1     =q7="};
     	{ 23, 11001, "", "=q3=Зачарованная шкатулка верховых животных", "=q5=x1     =q7="};
		Prev="MillenniumRoulettex2";
		Back = "KATEGORIAMENU";
	};
	...
	AtlasLoot_Data["BlackDiamonds2"] = {
		...
		{ 3, 40431, "", "=q4=Неистовство Пяти полетов", ""};
		{ 4, 40371, "", "=q4=Знак отличия Бандита", ""};
		{ 5, 40256, "", "=q4=Мрачный перезвон", ""};
		{ 6, 28121, "", "=q4=Хоругвь непреклонной отваги", ""};
		{ 7, 28579, "", "=q4=Флакон с ядом Ромуло", ""};
		{ 8, 47725, "", "=q4=Зов победителя", ""};
		{ 9, 28830, "", "=q4=Трофей из драконьего хребта", ""};
		{ 10, 47734, "", "=q4=Знак превосходства", ""};
		{ 11, 48722, "", "=q4=Осколок хрустального сердца", ""};
		{ 12, 47948, "", "=q4=Зов победителя гер", ""};
		{ 13, 47115, "", "=q4=Приговор смерти", ""};
		...
		{ 3, 40432, "", "=q4=Изображение души дракона", ""};
		{ 4, 40373, "", "=q4=Экстракт некромантского могущества", ""};
		{ 5, 40255, "", "=q4=Исчезающее проклятие", ""};
		{ 6, 27683, "", "=q4=Око Зыбуна", ""};
		{ 7, 28785, "", "=q4=Конденсатор молний", ""};
		{ 8, 47726, "", "=q4=Талисман неустойчивой силы", ""};
		{ 9, 49463, "", "=q4=Очищенная сфера пламени", ""};
		{ 10, 49310, "", "=q4=Очищенный обломок чешуи", ""};
		{ 11, 49488, "", "=q4=Блестящий обломок чешуи", ""};
		{ 12, 49464, "", "=q4=Блестящая сфера пламени", ""};
		{ 13, 48722, "", "=q4=Осколок хрустального сердца", ""};
		{ 14, 48724, "", "=q4=Талисман восстановления", ""};
		{ 15, 47946, "", "=q4=Талисман неустойчивой силы гер", ""};
		{ 18, 47182, "", "=q4=Власть неживых", ""};
		...
		{ 8, 47735, "", "=q4=Символ неукротимости", "#s14#"};
		{ 9, 49487, "", "=q4=Очищенный кровный талисман Ониксии", "#s14#"};
		{ 10, 47949, "", "=q4=Рвение Зиморожденного гер", "#s14#"};
		{ 11, 47080, "", "=q4=Упрямый скарабей Сатрины", "#s14#"};
		...
		{ 3, 40382, "", "=q4=Душа умершего", ""};
		{ 4, 40258, "", "=q4=Талисман предусмотрительности", ""};
		{ 5, 27896, "", "=q4=Перегонный куб мощи преисподней", ""};
		{ 6, 27828, "", "=q4=Покореженная скарабеем брошь", ""};
		{ 7, 28590, "", "=q4=Лента жертвоприношения", ""};
		{ 8, 28727, "", "=q4=Подвеска Аметистового Ока", ""};
		{ 9, 49463, "", "=q4=Очищенная сфера пламени", ""};
		{ 10, 49310, "", "=q4=Очищенный обломок чешуи", ""};
		{ 11, 47728, "", "=q4=Связующий свет", ""};
		{ 12, 28789, "", "=q4=Глаз Магтеридона", ""};
		{ 13, 28823, "", "=q4=Глаз Груула", ""};
		{ 14, 49488, "", "=q4=Блестящий обломок чешуи", ""};
		{ 15, 49464, "", "=q4=Блестящая сфера пламени", ""};
		{ 18, 48724, "", "=q4=Талисман восстановления", ""};
		{ 19, 47947, "", "=q4=Связующий свет гер", ""};
		{ 20, 47041, "", "=q4=Утешение поверженных", ""};
		...
		{ 1, 63841, "", "=q6=Знак отличия командира танка", "#s14#"};
		{ 2, 61462, "", "=q6=Детектор механизмов", "#s14#"};
		{ 3, 80774, "", "=q6=Медальон лесной гадюки", "#s14#"};
		{ 4, 63843, "", "=q6=Окровавленная кружка эля", "#s14#"};
		--{ 5, 38414, "", "=q6=Нагрудный доспех из обмерзшей чешуи", ""};
		{ 5, 80773, "", "=q6=Медальон поющего сверчка", "#s14#"};
		{ 6, 61411, "", "=q6=Поцелуй Матери-Скалы", "#s14#"};
		{ 7, 50362, "", "=q6=Воля Смертоносного", "#s14#"};
		{ 8, 50351, "", "=q6=Миниатюрное поганище в колбе", "#s14#"};
		{ 9, 50360, "", "=q6=Талисман безымянного лича", "#s14#"};
		{ 10, 50361, "", "=q6=Безупречный клык Синдрагосы", "#s14#"};
		{ 11, 30665, "", "=q6=Серьга душевной медитации", "#s14#"};
		{ 12, 30448, "", "=q6=Коготь Ала'ра", "#s14#"};
		...
		{ 7, 95592, "", "=q6=Гербовая накидка войск Похитителей Солнца", ""};
		{ 8, 97131, "", "=q6=Гербовая накидка Натиска Шадо-Пан", ""};
		{ 9, 89784, "", "=q6=Гербовая накидка землевладельцев", ""};
		{ 10, 89196, "", "=q6=Гербовая накидка Терамора", ""};
		{ 11, 89795, "", "=q6=Гербовая накидка хранителей истории", ""};
		{ 12, 63379, "", "=q6=Гербовая накидка защитников Тол Барада", ""};
		{ 13, 65906, "", "=q6=Гербовая накидка Стражей Хиджала", ""};
		{ 14, 65909, "", "=q6=Гербовая накидка клана Драконьей Пасти", ""};
		{ 15, 65908, "", "=q6=Гербовая накидка клана Гровомого Молота", ""};
		{ 16, 65905, "", "=q6=Гербовая накидка Служителей Земли", ""};
