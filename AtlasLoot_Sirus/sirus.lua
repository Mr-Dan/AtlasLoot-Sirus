...
{ 28, 0, "INV_Box_01", "=q6=Предмет", ""};
	...
	AtlasLoot_Data["Murozond25ManHEROIC"] ={
		...
		{ 22, 139040, "", "=q4=Песчинка потерянного времени", "=ds=#m3# "};
		...
		{ 3, 139045, "", "=q4=Плащ заживления Вневременного", "=ds=#s4# "};
		{ 4, 139046, "", "=q4=Мантия триумфа Вневременного", "=ds=#s4# "};
		{ 5, 139042, "", "=q4=Наколенники штурма Вневременного", "=ds=#s12#, #a4#"};
		{ 6, 139043, "", "=q4=Ботфорты натиска Вневременного", "=ds=#s12#, #a2# "};	
