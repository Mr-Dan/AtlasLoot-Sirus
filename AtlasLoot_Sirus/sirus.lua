...
AtlasLoot_Data["GoblinH"] = {
		{ 1, 101239, "", "Словарь гоблинского языка", ""};
		{ 2, 64884, "", "Гербовая накидка Трюмных Вод", ""};
		{ 3, 320255, "", "Сумка Картеля Трюмных Вод", ""};
		{ 4, 371160, "", "Утерянные наручи Устана", "=ds=90 #Hist#"};
		{ 5, 371166, "", "Утерянные наручи Устана", "=ds=90 #Hist#"};
		{ 6, 371172, "", "Утерянные наручи Устана", "=ds=90 #Hist#"};
		{ 7, 371178, "", "Утерянные наручи Устана", "=ds=90 #Hist#"};
		{ 8, 371184, "", "Утерянные наручи Устана", "=ds=90 #Hist#"};
		{ 9, 371190, "", "Утерянные наручи Устана", "=ds=90 #Hist#"};
		{ 10, 371161, "", "Модные наручи с пятнышком от мазута", "=ds=90 #Hist#"};
		{ 11, 371167, "", "Модные наручи с пятнышком от мазута", "=ds=90 #Hist#"};
		{ 12, 371173, "", "Модные наручи с пятнышком от мазута", "=ds=90 #Hist#"};
		{ 13, 371179, "", "Модные наручи с пятнышком от мазута", "=ds=90 #Hist#"};
		{ 14, 371185, "", "Модные наручи с пятнышком от мазута", "=ds=90 #Hist#"};
		{ 15, 371191, "", "Модные наручи с пятнышком от мазута", "=ds=90 #Hist#"};
		{ 16, 371162, "", "Пояс сборщика деталей", "=ds=90 #Hist#"};
		{ 17, 371168, "", "Пояс сборщика деталей", "=ds=90 #Hist#"};
		{ 18, 371174, "", "Пояс сборщика деталей", "=ds=90 #Hist#"};
		{ 19, 371180, "", "Пояс сборщика деталей", "=ds=90 #Hist#"};
		{ 20, 371186, "", "Пояс сборщика деталей", "=ds=90 #Hist#"};
		{ 21, 371192, "", "Пояс сборщика деталей", "=ds=90 #Hist#"};
		{ 22, 371163, "", "Пояс управляющего ТКК", "=ds=90 #Hist#"};
		{ 23, 371169, "", "Пояс управляющего ТКК", "=ds=90 #Hist#"};
		{ 24, 371175, "", "Пояс управляющего ТКК", "=ds=90 #Hist#"};
		{ 25, 371181, "", "Пояс управляющего ТКК", "=ds=90 #Hist#"};
		{ 26, 371187, "", "Пояс управляющего ТКК", "=ds=90 #Hist#"};
		{ 27, 371193, "", "Пояс управляющего ТКК", "=ds=90 #Hist#"};
		Next = "GoblinH1";	
	...
	AtlasLoot_Data["GoblinH1"] = {
		{ 1, 371164, "", "Пропитанные газом ботфорты", "=ds=90 #Hist#"};
		{ 2, 371170, "", "Пропитанные газом ботфорты", "=ds=90 #Hist#"};
		{ 3, 371176, "", "Пропитанные газом ботфорты", "=ds=90 #Hist#"};
		{ 4, 371182, "", "Пропитанные газом ботфорты", "=ds=90 #Hist#"};
		{ 5, 371188, "", "Пропитанные газом ботфорты", "=ds=90 #Hist#"};
		{ 6, 371194, "", "Пропитанные газом ботфорты", "=ds=90 #Hist#"};
		{ 7, 371165, "", "Ботинки полной катастрофы", "=ds=90 #Hist#"};
		{ 8, 371171, "", "Ботинки полной катастрофы", "=ds=90 #Hist#"};
		{ 9, 371177, "", "Ботинки полной катастрофы", "=ds=90 #Hist#"};
		{ 10, 371183, "", "Ботинки полной катастрофы", "=ds=90 #Hist#"};
		{ 11, 371189, "", "Ботинки полной катастрофы", "=ds=90 #Hist#"};
		{ 12, 371195, "", "Ботинки полной катастрофы", "=ds=90 #Hist#"};
		Prev = "GoblinH";		
		Back = "REPMENU_Sirus_History";			
	};
	
	AtlasLoot_Data["NagaH"] = {
		{ 1, 101241, "", "Словарь языка назжа", ""};
		{ 2, 155600, "", "Гербовая накидка Изгнанников Вайш'ира", ""};
		{ 3, 320256, "", "Сумка Изгнанников Вайш'ира", ""};
		{ 4, 371108, "", "Проклятые наручи морской ведьмы", "=ds=90 #Hist#"};
		{ 5, 371114, "", "Проклятые наручи морской ведьмы", "=ds=90 #Hist#"};
		{ 6, 371120, "", "Проклятые наручи морской ведьмы", "=ds=90 #Hist#"};
		{ 7, 371126, "", "Проклятые наручи морской ведьмы", "=ds=90 #Hist#"};
		{ 8, 371132, "", "Проклятые наручи морской ведьмы", "=ds=90 #Hist#"};
		{ 9, 371138, "", "Проклятые наручи морской ведьмы", "=ds=90 #Hist#"};
		{ 10, 371109, "", "Коралловые наручи", "=ds=90 #Hist#"};
		{ 11, 371115, "", "Коралловые наручи", "=ds=90 #Hist#"};
		{ 12, 371121, "", "Коралловые наручи", "=ds=90 #Hist#"};
		{ 13, 371127, "", "Коралловые наручи", "=ds=90 #Hist#"};
		{ 14, 371133, "", "Коралловые наручи", "=ds=90 #Hist#"};
		{ 15, 371139, "", "Коралловые наручи", "=ds=90 #Hist#"};
		{ 16, 371110, "", "Сандалии сил прибоя", "=ds=90 #Hist#"};
		{ 17, 371116, "", "Сандалии сил прибоя", "=ds=90 #Hist#"};
		{ 18, 371122, "", "Сандалии сил прибоя", "=ds=90 #Hist#"};
		{ 19, 371128, "", "Сандалии сил прибоя", "=ds=90 #Hist#"};
		{ 20, 371134, "", "Сандалии сил прибоя", "=ds=90 #Hist#"};
		{ 21, 371140, "", "Сандалии сил прибоя", "=ds=90 #Hist#"};
		{ 22, 371111, "", "Сапоги с манажемчужинами", "=ds=90 #Hist#"};
		{ 23, 371117, "", "Сапоги с манажемчужинами", "=ds=90 #Hist#"};
		{ 24, 371123, "", "Сапоги с манажемчужинами", "=ds=90 #Hist#"};
		{ 25, 371129, "", "Сапоги с манажемчужинами", "=ds=90 #Hist#"};
		{ 26, 371135, "", "Сапоги с манажемчужинами", "=ds=90 #Hist#"};
		{ 27, 371141, "", "Сапоги с манажемчужинами", "=ds=90 #Hist#"};
		Next = "NagaH1";
		Back = "REPMENU_Sirus_History";	
	...
	AtlasLoot_Data["NagaH1"] = {
		{ 1, 371112, "", "Мерцающий пояс", "=ds=90 #Hist#"};
		{ 2, 371118, "", "Мерцающий пояс", "=ds=90 #Hist#"};
		{ 3, 371124, "", "Мерцающий пояс", "=ds=90 #Hist#"};
		{ 4, 371130, "", "Мерцающий пояс", "=ds=90 #Hist#"};
		{ 5, 371136, "", "Мерцающий пояс", "=ds=90 #Hist#"};
		{ 6, 371142, "", "Мерцающий пояс", "=ds=90 #Hist#"};
		{ 7, 371113, "", "Резной пояс из Зин-Азшари", "=ds=90 #Hist#"};
		{ 8, 371119, "", "Резной пояс из Зин-Азшари", "=ds=90 #Hist#"};
		{ 9, 371125, "", "Резной пояс из Зин-Азшари", "=ds=90 #Hist#"};
		{ 10, 371131, "", "Резной пояс из Зин-Азшари", "=ds=90 #Hist#"};
		{ 11, 371137, "", "Резной пояс из Зин-Азшари", "=ds=90 #Hist#"};
		{ 12, 371143, "", "Резной пояс из Зин-Азшари", "=ds=90 #Hist#"};
		Prev = "NagaH";		
		Back = "REPMENU_Sirus_History";			
	};
	
	AtlasLoot_Data["VorgenH"] = {
		{ 1, 101229, "", "Словарь всеобщего языка", "=ds=90 #Hist#"};
		{ 2, 34628, "", "Гербовая накидка Гилнеаса", "=ds=90 #Hist#"};
		{ 3, 102904, "", "Сумка Гилнеаса", "=ds=90 #Hist#"};
		{ 4, 371396, "", "Напульсники душевного равновесия", "=ds=90 #Hist#"};
		{ 5, 371402, "", "Напульсники душевного равновесия", "=ds=90 #Hist#"};
		{ 6, 371408, "", "Напульсники душевного равновесия", "=ds=90 #Hist#"};
		{ 7, 371414, "", "Напульсники душевного равновесия", "=ds=90 #Hist#"};
		{ 8, 371420, "", "Напульсники душевного равновесия", "=ds=90 #Hist#"};
		{ 9, 371427, "", "Напульсники душевного равновесия", "=ds=90 #Hist#"};
		{ 10, 371397, "", "Дорогие поручи знатного рода Краули", "=ds=90 #Hist#"};
		{ 11, 371403, "", "Дорогие поручи знатного рода Краули", "=ds=90 #Hist#"};
		{ 12, 371409, "", "Дорогие поручи знатного рода Краули", "=ds=90 #Hist#"};
		{ 13, 371415, "", "Дорогие поручи знатного рода Краули", "=ds=90 #Hist#"};
		{ 14, 371421, "", "Дорогие поручи знатного рода Краули", "=ds=90 #Hist#"};
		{ 15, 371428, "", "Дорогие поручи знатного рода Краули", "=ds=90 #Hist#"};
		{ 16, 371398, "", "Изодранный пояс плохого врачевателя", "=ds=90 #Hist#"};
		{ 17, 371404, "", "Изодранный пояс плохого врачевателя", "=ds=90 #Hist#"};
		{ 18, 371410, "", "Изодранный пояс плохого врачевателя", "=ds=90 #Hist#"};
		{ 19, 371416, "", "Изодранный пояс плохого врачевателя", "=ds=90 #Hist#"};
		{ 20, 371423, "", "Изодранный пояс плохого врачевателя", "=ds=90 #Hist#"};
		{ 21, 371429, "", "Изодранный пояс плохого врачевателя", "=ds=90 #Hist#"};
		{ 22, 371399, "", "Пояс гилнеасского дворянина", "=ds=90 #Hist#"};
		{ 23, 371405, "", "Пояс гилнеасского дворянина", "=ds=90 #Hist#"};
		{ 24, 371411, "", "Пояс гилнеасского дворянина", "=ds=90 #Hist#"};
		{ 25, 371417, "", "Пояс гилнеасского дворянина", "=ds=90 #Hist#"};
		{ 26, 371424, "", "Пояс гилнеасского дворянина", "=ds=90 #Hist#"};
		{ 27, 371430, "", "Пояс гилнеасского дворянина", "=ds=90 #Hist#"};
		Next = "VorgenH1";	
		Back = "REPMENU_Sirus_History";			
	};
		AtlasLoot_Data["VorgenH1"] = {
		{ 1, 371400, "", "Высокие ботинки темного следопыта", "=ds=90 #Hist#"};
		{ 2, 371406, "", "Высокие ботинки темного следопыта", "=ds=90 #Hist#"};
		{ 3, 371412, "", "Высокие ботинки темного следопыта", "=ds=90 #Hist#"};
		{ 4, 371418, "", "Высокие ботинки темного следопыта", "=ds=90 #Hist#"};
		{ 5, 371425, "", "Высокие ботинки темного следопыта", "=ds=90 #Hist#"};
		{ 6, 371431, "", "Высокие ботинки темного следопыта", "=ds=90 #Hist#"};
		{ 7, 371401, "", "Сапоги со следами от зубов мастифа", "=ds=90 #Hist#"};
		{ 8, 371407, "", "Сапоги со следами от зубов мастифа", "=ds=90 #Hist#"};
		{ 9, 371413, "", "Сапоги со следами от зубов мастифа", "=ds=90 #Hist#"};
		{ 10, 371419, "", "Сапоги со следами от зубов мастифа", "=ds=90 #Hist#"};
		{ 11, 371426, "", "Сапоги со следами от зубов мастифа", "=ds=90 #Hist#"};
		{ 12, 371432, "", "Сапоги со следами от зубов мастифа", "=ds=90 #Hist#"};
		Prev = "VorgenH";		
		Back = "REPMENU_Sirus_History";			
	};
	
		AtlasLoot_Data["HelfH"] = {
		{ 1, 101234, "", "Словарь талассийского языка", "=ds=90 #Hist#"};
		{ 2, 320258, "", "Сумка Эльдранила", "=ds=90 #Hist#"};
		{ 3, 155629, "", "Гербовая накидка Эльдранила", "=ds=90 #Hist#"};
		{ 4, 371344, "", "Покрытые эфиром наручи", "=ds=90 #Hist#"};
		{ 5, 371350, "", "Покрытые эфиром наручи", "=ds=90 #Hist#"};
		{ 6, 371356, "", "Покрытые эфиром наручи", "=ds=90 #Hist#"};
		{ 7, 371362, "", "Покрытые эфиром наручи", "=ds=90 #Hist#"};
		{ 8, 371368, "", "Покрытые эфиром наручи", "=ds=90 #Hist#"};
		{ 9, 371374, "", "Покрытые эфиром наручи", "=ds=90 #Hist#"};
		{ 10, 371345, "", "Украшенные наручи Больадила", "=ds=90 #Hist#"};
		{ 11, 371351, "", "Украшенные наручи Больадила", "=ds=90 #Hist#"};
		{ 12, 371357, "", "Украшенные наручи Больадила", "=ds=90 #Hist#"};
		{ 13, 371363, "", "Украшенные наручи Больадила", "=ds=90 #Hist#"};
		{ 14, 371369, "", "Украшенные наручи Больадила", "=ds=90 #Hist#"};
		{ 15, 371375, "", "Украшенные наручи Больадила", "=ds=90 #Hist#"};
		{ 16, 371346, "", "Сапоги руноманта", "=ds=90 #Hist#"};
		{ 17, 371352, "", "Сапоги руноманта", "=ds=90 #Hist#"};
		{ 18, 371358, "", "Сапоги руноманта", "=ds=90 #Hist#"};
		{ 19, 371364, "", "Сапоги руноманта", "=ds=90 #Hist#"};
		{ 20, 371370, "", "Сапоги руноманта", "=ds=90 #Hist#"};
		{ 21, 371376, "", "Сапоги руноманта", "=ds=90 #Hist#"};
		{ 22, 371347, "", "Изысканные сапоги из Нораласа", "=ds=90 #Hist#"};
		{ 23, 371353, "", "Изысканные сапоги из Нораласа", "=ds=90 #Hist#"};
		{ 24, 371359, "", "Изысканные сапоги из Нораласа", "=ds=90 #Hist#"};
		{ 25, 371365, "", "Изысканные сапоги из Нораласа", "=ds=90 #Hist#"};
		{ 26, 371371, "", "Изысканные сапоги из Нораласа", "=ds=90 #Hist#"};
		{ 27, 371377, "", "Изысканные сапоги из Нораласа", "=ds=90 #Hist#"};
		Next = "HelfH1";		
		Back = "REPMENU_Sirus_History";			
	};
	
		AtlasLoot_Data["HelfH1"] = {
		{ 1, 371348, "", "Невесомый пояс из паутины тенепута", "=ds=90 #Hist#"};
		{ 2, 371354, "", "Невесомый пояс из паутины тенепута", "=ds=90 #Hist#"};
		{ 3, 371360, "", "Невесомый пояс из паутины тенепута", "=ds=90 #Hist#"};
		{ 4, 371366, "", "Невесомый пояс из паутины тенепута", "=ds=90 #Hist#"};
		{ 5, 371372, "", "Невесомый пояс из паутины тенепута", "=ds=90 #Hist#"};
		{ 6, 371378, "", "Невесомый пояс из паутины тенепута", "=ds=90 #Hist#"};
		{ 7, 371349, "", "Крепкий пояс стража Диколесья", "=ds=90 #Hist#"};
		{ 8, 371355, "", "Крепкий пояс стража Диколесья", "=ds=90 #Hist#"};
		{ 9, 371361, "", "Крепкий пояс стража Диколесья", "=ds=90 #Hist#"};
		{ 10, 371367, "", "Крепкий пояс стража Диколесья", "=ds=90 #Hist#"};
		{ 11, 371373, "", "Крепкий пояс стража Диколесья", "=ds=90 #Hist#"};
		{ 12, 371379, "", "Крепкий пояс стража Диколесья", "=ds=90 #Hist#"};
		Prev = "HelfH";		
		Back = "REPMENU_Sirus_History";			
	};
	
		AtlasLoot_Data["PandH"] = {
		{ 1, 101240, "", "Словарь пандаренского языка", "=ds=90 #Hist#"};
		{ 2, 102911, "", "Гербовая накидка Ордена Красного Журавля", "=ds=90 #Hist#"};
		{ 3, 102910, "", "Сумка Ордена Красного Журавля", "=ds=90 #Hist#"};
		{ 4, 102910, "", "Отрезвин", "=ds=90 #Hist#"};
		{ 5, 50084, "", "Портвейн Три топора", "=ds=90 #Hist#"};
		{ 6, 371212, "", "Поручи из павлиньих перьев", "=ds=90 #Hist#"};
		{ 7, 371219, "", "Поручи из павлиньих перьев", "=ds=90 #Hist#"};
		{ 8, 371226, "", "Поручи из павлиньих перьев", "=ds=90 #Hist#"};
		{ 9, 371233, "", "Поручи из павлиньих перьев", "=ds=90 #Hist#"};
		{ 10, 371240, "", "Поручи из павлиньих перьев", "=ds=90 #Hist#"};
		{ 11, 371247, "", "Поручи из павлиньих перьев", "=ds=90 #Hist#"};
		{ 12, 371213, "", "Наручи со скрытым нефритом", "=ds=90 #Hist#"};
		{ 13, 371220, "", "Наручи со скрытым нефритом", "=ds=90 #Hist#"};
		{ 14, 371227, "", "Наручи со скрытым нефритом", "=ds=90 #Hist#"};
		{ 15, 371234, "", "Наручи со скрытым нефритом", "=ds=90 #Hist#"};
		{ 16, 371241, "", "Наручи со скрытым нефритом", "=ds=90 #Hist#"};
		{ 17, 371248, "", "Наручи со скрытым нефритом", "=ds=90 #Hist#"};
		{ 18, 371214, "", "Забытый ремень из руин Гун-Цзе", "=ds=90 #Hist#"};
		{ 19, 371221, "", "Забытый ремень из руин Гун-Цзе", "=ds=90 #Hist#"};
		{ 20, 371228, "", "Забытый ремень из руин Гун-Цзе", "=ds=90 #Hist#"};
		{ 21, 371235, "", "Забытый ремень из руин Гун-Цзе", "=ds=90 #Hist#"};
		{ 22, 371242, "", "Забытый ремень из руин Гун-Цзе", "=ds=90 #Hist#"};
		{ 23, 371249, "", "Забытый ремень из руин Гун-Цзе", "=ds=90 #Hist#"};
		{ 24, 371215, "", "Императорский пояс", "=ds=90 #Hist#"};
		{ 25, 371222, "", "Императорский пояс", "=ds=90 #Hist#"};
		{ 26, 371229, "", "Императорский пояс", "=ds=90 #Hist#"};
		{ 27, 371236, "", "Императорский пояс", "=ds=90 #Hist#"};
		{ 28, 371243, "", "Императорский пояс", "=ds=90 #Hist#"};
		{ 29, 371250, "", "Императорский пояс", "=ds=90 #Hist#"};
		Next = "PandH1";		
		Back = "REPMENU_Sirus_History";			
	};
	
		AtlasLoot_Data["PandH1"] = {
		{ 1, 371216, "", "Кожанные сапоги из ядоплюя", "=ds=90 #Hist#"};
		{ 2, 371223, "", "Кожанные сапоги из ядоплюя", "=ds=90 #Hist#"};
		{ 3, 371230, "", "Кожанные сапоги из ядоплюя", "=ds=90 #Hist#"};
		{ 4, 371237, "", "Кожанные сапоги из ядоплюя", "=ds=90 #Hist#"};
		{ 5, 371244, "", "Кожанные сапоги из ядоплюя", "=ds=90 #Hist#"};
		{ 6, 371251, "", "Кожанные сапоги из ядоплюя", "=ds=90 #Hist#"};
		{ 7, 371217, "", "Тяжелые сапоги спокойстви", "=ds=90 #Hist#"};
		{ 8, 371224, "", "Тяжелые сапоги спокойстви", "=ds=90 #Hist#"};
		{ 9, 371231, "", "Тяжелые сапоги спокойстви", "=ds=90 #Hist#"};
		{ 10, 371238, "", "Тяжелые сапоги спокойстви", "=ds=90 #Hist#"};
		{ 11, 371245, "", "Тяжелые сапоги спокойстви", "=ds=90 #Hist#"};
		{ 12, 371252, "", "Тяжелые сапоги спокойстви", "=ds=90 #Hist#"};
		{ 13, 371218, "", "Ботинки шести быков", "=ds=90 #Hist#"};
		{ 14, 371225, "", "Ботинки шести быков", "=ds=90 #Hist#"};
		{ 15, 371232, "", "Ботинки шести быков", "=ds=90 #Hist#"};
		{ 16, 371239, "", "Ботинки шести быков", "=ds=90 #Hist#"};
		{ 17, 371246, "", "Ботинки шести быков", "=ds=90 #Hist#"};
		{ 18, 371253, "", "Ботинки шести быков", "=ds=90 #Hist#"};
		Prev = "PandH";		
		Back = "REPMENU_Sirus_History";			
	};
		AtlasLoot_Data["VulpH"] = {
		{ 1, 101242, "", "Словарь наречия вульпера", "=ds=90 #Hist#"};
		{ 2, 102915, "", "Гербовая накидка Абимайских искателей", "=ds=90 #Hist#"};
		{ 3, 102914, "", "Сумка Абимайских искателей", "=ds=90 #Hist#"};
		{ 4, 371278, "", "Боевые наручи странника пустыни", "=ds=90 #Hist#"};
		{ 5, 371285, "", "Боевые наручи странника пустыни", "=ds=90 #Hist#"};
		{ 6, 371292, "", "Боевые наручи странника пустыни", "=ds=90 #Hist#"};
		{ 7, 371299, "", "Боевые наручи странника пустыни", "=ds=90 #Hist#"};
		{ 8, 371306, "", "Боевые наручи странника пустыни", "=ds=90 #Hist#"};
		{ 9, 371313, "", "Боевые наручи странника пустыни", "=ds=90 #Hist#"};
		{ 10, 371279, "", "Наручи зыбучих песков", "=ds=90 #Hist#"};
		{ 11, 371286, "", "Наручи зыбучих песков", "=ds=90 #Hist#"};
		{ 12, 371293, "", "Наручи зыбучих песков", "=ds=90 #Hist#"};
		{ 13, 371300, "", "Наручи зыбучих песков", "=ds=90 #Hist#"};
		{ 14, 371307, "", "Наручи зыбучих песков", "=ds=90 #Hist#"};
		{ 15, 371314, "", "Наручи зыбучих песков", "=ds=90 #Hist#"};
		{ 16, 371280, "", "Запылившийся пустынный пояс", "=ds=90 #Hist#"};
		{ 17, 371287, "", "Запылившийся пустынный пояс", "=ds=90 #Hist#"};
		{ 18, 371294, "", "Запылившийся пустынный пояс", "=ds=90 #Hist#"};
		{ 19, 371301, "", "Запылившийся пустынный пояс", "=ds=90 #Hist#"};
		{ 20, 371308, "", "Запылившийся пустынный пояс", "=ds=90 #Hist#"};
		{ 21, 371315, "", "Запылившийся пустынный пояс", "=ds=90 #Hist#"};
		{ 22, 371281, "", "Пояс мудреца оазиса", "=ds=90 #Hist#"};
		{ 23, 371288, "", "Пояс мудреца оазиса", "=ds=90 #Hist#"};
		{ 24, 371295, "", "Пояс мудреца оазиса", "=ds=90 #Hist#"};
		{ 25, 371302, "", "Пояс мудреца оазиса", "=ds=90 #Hist#"};
		{ 26, 371309, "", "Пояс мудреца оазиса", "=ds=90 #Hist#"};
		{ 27, 371316, "", "Пояс мудреца оазиса", "=ds=90 #Hist#"};
		Next = "VulpH1";	
		Back = "REPMENU_Sirus_History";			
	};
		AtlasLoot_Data["VulpH1"] = {
		{ 1, 371282, "", "Сандалии пустынного странника", "=ds=90 #Hist#"};
		{ 2, 371289, "", "Сандалии пустынного странника", "=ds=90 #Hist#"};
		{ 3, 371296, "", "Сандалии пустынного странника", "=ds=90 #Hist#"};
		{ 4, 371303, "", "Сандалии пустынного странника", "=ds=90 #Hist#"};
		{ 5, 371310, "", "Сандалии пустынного странника", "=ds=90 #Hist#"};
		{ 6, 371317, "", "Сандалии пустынного странника", "=ds=90 #Hist#"};
		{ 7, 371283, "", "Тяжелые сапоги первой экспедиции", "=ds=90 #Hist#"};
		{ 8, 371290, "", "Тяжелые сапоги первой экспедиции", "=ds=90 #Hist#"};
		{ 9, 371297, "", "Тяжелые сапоги первой экспедиции", "=ds=90 #Hist#"};
		{ 10, 371304, "", "Тяжелые сапоги первой экспедиции", "=ds=90 #Hist#"};
		{ 11, 371311, "", "Тяжелые сапоги первой экспедиции", "=ds=90 #Hist#"};
		{ 12, 371318, "", "Тяжелые сапоги первой экспедиции", "=ds=90 #Hist#"};
		{ 13, 371284, "", "Начищенные сапоги защитника каравана", "=ds=90 #Hist#"};
		{ 14, 371291, "", "Начищенные сапоги защитника каравана", "=ds=90 #Hist#"};
		{ 15, 371298, "", "Начищенные сапоги защитника каравана", "=ds=90 #Hist#"};
		{ 16, 371305, "", "Начищенные сапоги защитника каравана", "=ds=90 #Hist#"};
		{ 17, 371312, "", "Начищенные сапоги защитника каравана", "=ds=90 #Hist#"};
		{ 18, 371319, "", "Начищенные сапоги защитника каравана", "=ds=90 #Hist#"};
		Prev = "VulpH";		
		Back = "REPMENU_Sirus_History";			
	};
		AtlasLoot_Data["DraktH"] = {
		{ 1, 101257, "", "Словарь драконего языка", "=ds=90 #Hist#"};
		{ 2, 102713, "", "Гербовая накидка смелого драктира", "=ds=90 #Hist#"};
		{ 3, 102711, "", "Сумка драктира", "=ds=90 #Hist#"};
		{ 4, 371050, "", "Манжеты чешуеклята", "=ds=90 #Hist#"};
		{ 5, 371057, "", "Манжеты чешуеклята", "=ds=90 #Hist#"};
		{ 6, 371064, "", "Манжеты чешуеклята", "=ds=90 #Hist#"};
		{ 7, 371071, "", "Манжеты чешуеклята", "=ds=90 #Hist#"};
		{ 8, 371078, "", "Манжеты чешуеклята", "=ds=90 #Hist#"};
		{ 9, 371085, "", "Манжеты чешуеклята", "=ds=90 #Hist#"};
		{ 10, 371051, "", "Наручники когтей свирепости", "=ds=90 #Hist#"};
		{ 11, 371058, "", "Наручники когтей свирепости", "=ds=90 #Hist#"};
		{ 12, 371065, "", "Наручники когтей свирепости", "=ds=90 #Hist#"};
		{ 13, 371072, "", "Наручники когтей свирепости", "=ds=90 #Hist#"};
		{ 14, 371079, "", "Наручники когтей свирепости", "=ds=90 #Hist#"};
		{ 15, 371086, "", "Наручники когтей свирепости", "=ds=90 #Hist#"};
		{ 16, 371052, "", "Могучие наручи дракомондира", "=ds=90 #Hist#"};
		{ 17, 371059, "", "Могучие наручи дракомондира", "=ds=90 #Hist#"};
		{ 18, 371066, "", "Могучие наручи дракомондира", "=ds=90 #Hist#"};
		{ 19, 371073, "", "Могучие наручи дракомондира", "=ds=90 #Hist#"};
		{ 20, 371080, "", "Могучие наручи дракомондира", "=ds=90 #Hist#"};
		{ 21, 371087, "", "Могучие наручи дракомондира", "=ds=90 #Hist#"};
		{ 22, 371053, "", "Рунный пояс гаруспика Кордхейма", "=ds=90 #Hist#"};
		{ 23, 371060, "", "Рунный пояс гаруспика Кордхейма", "=ds=90 #Hist#"};
		{ 24, 371067, "", "Рунный пояс гаруспика Кордхейма", "=ds=90 #Hist#"};
		{ 25, 371074, "", "Рунный пояс гаруспика Кордхейма", "=ds=90 #Hist#"};
		{ 26, 371081, "", "Рунный пояс гаруспика Кордхейма", "=ds=90 #Hist#"};
		{ 27, 371088, "", "Рунный пояс гаруспика Кордхейма", "=ds=90 #Hist#"};
		Next = "DraktH1";
		Back = "REPMENU_Sirus_History";			
	};
		AtlasLoot_Data["DraktH1"] = {
		{ 1, 371054, "", "Ремень хранителя сна", "=ds=90 #Hist#"};
		{ 2, 371061, "", "Ремень хранителя сна", "=ds=90 #Hist#"};
		{ 3, 371068, "", "Ремень хранителя сна", "=ds=90 #Hist#"};
		{ 4, 371075, "", "Ремень хранителя сна", "=ds=90 #Hist#"};
		{ 5, 371082, "", "Ремень хранителя сна", "=ds=90 #Hist#"};
		{ 6, 371089, "", "Ремень хранителя сна", "=ds=90 #Hist#"};
		{ 7, 371055, "", "Пояс пламенного дыхания", "=ds=90 #Hist#"};
		{ 8, 371062, "", "Пояс пламенного дыхания", "=ds=90 #Hist#"};
		{ 9, 371069, "", "Пояс пламенного дыхания", "=ds=90 #Hist#"};
		{ 10, 371076, "", "Пояс пламенного дыхания", "=ds=90 #Hist#"};
		{ 11, 371083, "", "Пояс пламенного дыхания", "=ds=90 #Hist#"};
		{ 12, 371090, "", "Пояс пламенного дыхания", "=ds=90 #Hist#"};
		{ 13, 371056, "", "Ботфорты сновидца", "=ds=90 #Hist#"};
		{ 14, 371063, "", "Ботфорты сновидца", "=ds=90 #Hist#"};
		{ 15, 371070, "", "Ботфорты сновидца", "=ds=90 #Hist#"};
		{ 16, 371077, "", "Ботфорты сновидца", "=ds=90 #Hist#"};
		{ 17, 371084, "", "Ботфорты сновидца", "=ds=90 #Hist#"};
		{ 18, 371091, "", "Ботфорты сновидца", "=ds=90 #Hist#"};
		Prev = "DraktH";		
		Back = "REPMENU_Sirus_History";			
	};
