...
{ 28, 0, "INV_Box_01", "=q6=Предмет", ""};
	...
	AtlasLoot_Data["Golden_Scorpid6_x4"] = {
		...
		--[[ 
		Импорус - 271 (обычное убийство) + 277 (если активен сложный режим).
		Элонус - 271 (обычное убийство) + 277 (если активен сложный режим).
		Мурозонд - 277 (обычное убийство) +284 (если активен сложный режим).
		
		Импорус - 284 (обычное убийство) + 290 (обычное убийство) + несколько Песчинок потерянного времени (если активен сложный режим).
		Элонус - 284 (обычное убийство) + 290 (обычное убийство) + несколько Песчинок потерянного времени (если активен сложный режим).
		Мурозонд - 290 (обычное убийство) +297 (обычное убийство) + несколько Песчинок потерянного времени (если активен сложный режим).
	...
	AtlasLoot_Data["Murozond25Man"] ={
		...
		{ 26, 157109, "", "=q4=Фантом конца времени", "=ds=#e12# "};	
	...
	AtlasLoot_Data["Imporus25ManHEROIC"] ={
		...
		{ 17, 139040, "", "=q4=Песчинка потерянного времени", "=ds= "};
	...
	AtlasLoot_Data["Murozond25ManHEROIC"] ={
		...
		{ 22, 139040, "", "=q4=Песчинка потерянного времени", "=ds= "};
		{ 24, 155715, "", "=q4=Поводья Эха Времени", "=ds=#e12# "};
