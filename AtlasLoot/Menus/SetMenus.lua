...
local BabbleZone = AtlasLoot_GetLocaleLibBabble("LibBabble-Zone-3.0")
	...
	AtlasLoot_Data["T5SET"] = {
		{ 1, "T5DeathKnightDPS", "Spell_Deathknight_UnholyPresence","ДК ДД - Нечестивость"};
		{ 2, "T5DeathKnightDPSfrost", "Spell_Deathknight_FrostPresence", "ДК ДД - Фрост"};
		{ 3, "T5DeathKnightDPSblood", "Spell_Deathknight_BloodPresence", "ДК ДД - Блад"};
		{ 5, "T5DeathKnightTank", "Spell_Deathknight_UnholyPresence", "ДК - Танк Нечестивость"};
		{ 6, "T5DeathKnightTankfrost", "Spell_Deathknight_FrostPresence", "ДК - Танк Фрост"};
		{ 7, "T5DeathKnightTankblood", "Spell_Deathknight_BloodPresence", "ДК - Танк Блад"};
		{ 9, "T5DruidBalance", "Spell_Nature_ForceOfNature", "Друид - Сова"};
		{ 10, "T5DruidFeral", "Ability_Racial_BearForm", "Друид - Мишка"};
		{ 11, "T5DruidFeralDD", "Ability_Druid_CatForm", "Друид - Кот"};
		{ 12, "T5DruidRestoration", "Ability_Druid_TreeofLife", "Друид - Полено"};
		{ 16, "T5Hunter", "Ability_Hunter_BeastTaming", "Хант - БМ"};
		{ 17, "T5Huntermm", "Ability_Marksmanship", "Хант - ММ"};
		{ 18, "T5Huntersu", "Ability_Hunter_SwiftStrike", "Хант - Сурв"};
		{ 20, "T5Mage", "Spell_Holy_MagicalSentry", "Маг - Аркан"};
		{ 21, "T5Magefire", "Spell_Fire_FireBolt02", "Маг - Фаер"};
		{ 22, "T5Magefrost", "Spell_Frost_FrostBolt02", "Маг - Фрост"};
		{ 24, "T5PaladinHoly", "Spell_Holy_HolyBolt", "Паладин - Свет"};
		{ 25, "T5PaladinProtection", "Spell_Holy_DevotionAura", "Паладин - Защита"};
		{ 26, "T5PaladinRetribution", "Spell_Holy_AuraOfLight", "Паладин - Воздаяние"};
		{ 28, "T5PriestHolydz", "Spell_Holy_WordFortitude", "Жрец - Послушание"};
		{ 29, "T5PriestHoly", "Spell_Holy_GuardianSpirit", "Жрец - Свет"};
		{ 30, "T5PriestShadow", "Spell_Shadow_ShadowWordPain", "Жрец - Тьма"};
		Back = "SETMENU";
		Next = "T5SET2";
	};
	AtlasLoot_Data["T5SET2"] = {
		{ 2, "T5Rogue", "Ability_Rogue_Eviscerate","Разбойник - Ликвидация"};
		{ 3, "T5Roguekomb", "Ability_BackStab", "Разбойник - Бой"};
		{ 4, "T5Rogueshd", "Ability_Stealth", "Разбойник - Скрытность"};
		{ 6, "T5ShamanElemental", "Spell_Nature_Lightning", "Шаман - Стихии"};
		{ 7, "T5ShamanEnhancement", "Spell_Nature_LightningShield", "Шаман - Совершенствование"};
		{ 8, "T5ShamanRestoration", "Spell_Nature_MagicImmunity", "Шаман - Исцеление"};
