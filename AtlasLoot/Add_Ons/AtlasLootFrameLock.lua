...
ALLockButton = CreateFrame("Button", nil, AtlasLootDefaultFrame)
	ALLockButton:SetPoint("TOPRIGHT", AtlasLootDefaultFrame, -30, -45)
	...
	ALLockButtontex:SetTexture("Interface\\AddOns\\AtlasLoot\\Images\\zamok_l.blp")
	end
